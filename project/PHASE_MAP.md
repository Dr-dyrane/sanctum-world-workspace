...
KM04 update 6/8: v2 redesign planning exists only as review material at `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-plan.md` and `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`. The v2 proposal has not been built, staged to platform-current, uploaded, AutoQC-run, Taiga-run, or advanced into FA/GA/PL/final review.
