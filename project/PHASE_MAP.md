...
- Grader guidance construction, grader guidelines, rubrics, scoring thresholds, AutoQC responses, or later task-layer output generation unless explicitly authorized by Alexander
- World file review
