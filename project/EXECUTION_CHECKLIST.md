...
- [ ] Finalize Brainstorm draft
  - Platform: Local workspace
  - Expected output: `worlds/korvin-merrow/active/brainstorm.md` contains final physician-approved Brainstorm content
...
- [ ] Review Brainstorm feedback
  ...
  - Expected output: Reviewer comments captured in `worlds/korvin-merrow/reviews/reviewer-feedback.md`
...
- [ ] Review World Spec feedback
  - Platform: RL Studio, Slack only for clarification
  - Expected output: Feedback captured in `worlds/korvin-merrow/reviews/reviewer-feedback.md`
  - Stop condition: Feedback is unclear and needs reviewer clarification
  - Reviewer: Alexander and Codex
