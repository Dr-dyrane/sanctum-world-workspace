...
Status: active / awaiting Abi round-2 review. Task 1 AO Review Rework is active after Abi send-back; RLS rework entry, Task AutoQC rerun, batch v3 trajectories/QA, and round-2 FA/GA submission are complete. Tasks 2-6 remain held until Task 1 rework is accepted or Alexander explicitly authorizes bounded parallel prep.
Current contents:
