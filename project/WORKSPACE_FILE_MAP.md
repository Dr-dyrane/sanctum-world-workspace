...
45. `worlds/korvin-merrow/synthetic-files/locked/batch-4/batch-4-validation-review.md` for locked Batch 4 validation.
46. `worlds/korvin-merrow/synthetic-files/ratifications/batch-4-ratification.md` for Batch 4 lock record.
47. `worlds/korvin-merrow/synthetic-files/locked/batch-5/batch-5-validation-review.md` for locked Batch 5 validation.
48. `worlds/korvin-merrow/synthetic-files/ratifications/batch-5-ratification.md` for Batch 5 lock record and world-level layer completion.
49. `worlds/korvin-merrow/reviews/world-level-layer-closure-audit.md` for world-level closure audit result.
50. `worlds/korvin-merrow/task-layer-architecture/candidate-review/task-level-context-file-architecture-v1.md` for current task-layer architecture candidate review.
51. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
52. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
53. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
