...
57. `worlds/korvin-merrow/supplementary-file-architecture/candidate-review/supplementary-file-architecture-v1.md` for lock-ready candidate FI-S architecture.
58. `worlds/korvin-merrow/supplementary-file-architecture/candidate-review/supplementary-file-architecture-validation-review.md` for lock-ready candidate FI-S architecture validation.
59. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
60. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
61. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `worlds/korvin-merrow/supplementary-file-architecture/` is now a lifecycle folder for FI-S architecture only. Supplementary File Architecture v1 is lock ready; no FI-S files exist.
...
- `candidate-review/`: active supplementary architecture artifacts awaiting lock. Supplementary File Architecture v1 is currently lock ready.
