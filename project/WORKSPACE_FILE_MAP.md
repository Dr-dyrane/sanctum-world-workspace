...
3. `worlds/korvin-merrow/task-setup/platform/task2/escalation/README.md` for the current Task 2 escalation run package.
4. `worlds/korvin-merrow/task-setup/task2/KM02-pilot-failure-analysis.md` for why the clean pilot failed as a difficulty mechanism.
5. `worlds/korvin-merrow/task-setup/platform/task2/README.md` for the clean-pilot platform set and Task AutoQC history.
6. `worlds/korvin-merrow/task-setup/task2/KM02-design-plan-for-review.md` for Task 2 red-team study and discriminator history.
7. `worlds/korvin-merrow/task-setup/platform/task1/` for live Task 1 platform artifacts.
8. `worlds/korvin-merrow/task-setup/platform/task1/archive/` only for historical Task 1 iterations.
...
- `worlds/korvin-merrow/task-setup/platform/task2/escalation/`: current Task 2 escalation platform set. Contains `README.md`, `prompt-task2-escalation.txt`, and `discharge_summary_draft_incomplete_05242026.docx`. Use only for the Alexander-operated Task-Writing Go-Back escalation run; golden and grader remain unchanged from the clean-pilot set.
...
- Task 1 final human review is complete. Task 2 clean pilot was too easy and escalation materials are staged locally; do not run additional task uploads, additional agent runs, additional QA runs, create AutoQC responses, create scoring artifacts, or mutate RL Studio beyond the exact authorized escalation step without explicit Alexander authorization.
