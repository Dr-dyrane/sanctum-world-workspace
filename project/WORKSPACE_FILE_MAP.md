...
- `worlds/korvin-merrow/task-setup/task2/KM02-design-plan-for-review.md`: Task 2 / KM02 pre-build discriminator design plan for external red-team review. Study/review material only; it does not create a prompt, golden, grader, task upload, or platform mutation.
- `worlds/korvin-merrow/task-setup/task2/KM02-review-bundle.zip`: zipped KM02 review bundle containing the design plan, locked KM02 canon, continuity references, and live 26-file world snapshot for red-team review. Review source bundle only; not a submission package and not an upload artifact.
