...
- `worlds/korvin-merrow/task-setup/task5/design/KM05-v2-design-plan-6-8.md`: Current KM05 review-only reset plan. Lead hypothesis is a single unsupported post-discharge BMP / stable renal-potassium monitoring claim inside a transition-clinic draft. No build or platform action.
...
6/8: KM05 NO-MODERATE RESET. Start at task5/TASK5-STATE.md and task5/design/KM05-v2-design-plan-6-8.md. Older 6/7 convergence material is history only. Proposed v2 mechanism: transition-clinic completion draft with one unsupported post-discharge BMP / stable renal-potassium monitoring claim; correct answer converts it to a verification target, failure carries it as fact. NOT performed: DOCX build, platform-current staging, RL Studio upload, Task AutoQC, Taiga trajectories, QA, FA/GA, PL, or platform mutation.
