...
60. `worlds/korvin-merrow/supplementary-files/candidate-review/supplementary-file-construction-validation-review.md` for FI-S construction candidate validation.
61. `worlds/korvin-merrow/supplementary-files/candidate-review/` for candidate FI-S01 through FI-S04 files.
62. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
63. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
64. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active supplementary FI-S files awaiting review or lock. FI-S01 through FI-S04 are currently here.
- Future `locked/`: locked supplementary files after ratification.
- Future `ratifications/`: ratification records for supplementary file construction.
...
| File | Role | Duplication note |
| --- | --- | --- |
| `worlds/korvin-merrow/supplementary-files/candidate-review/FI-S01_remote-pci-coronary-stent-provenance-summary.md` | Candidate FI-S01 supplementary file. | Remote PCI/CAD provenance only; not a GDMT restart answer, medication reconciliation, consultant synthesis, or discharge plan. |
| `worlds/korvin-merrow/supplementary-files/candidate-review/FI-S02_remote-sleep-study-osa-provenance-summary.md` | Candidate FI-S02 supplementary file. | Remote OSA provenance only; not an explanation for functional decline, near-fall, acute presentation, or discharge readiness. |
| `worlds/korvin-merrow/supplementary-files/candidate-review/FI-S03_home-support-equipment-logistics-reference.md` | Candidate FI-S03 supplementary file. | Home support/equipment logistics only; secondary Trap #5 texture, not a final discharge plan, services authorization, or safe/unsafe discharge answer. |
| `worlds/korvin-merrow/supplementary-files/candidate-review/FI-S04_problem-list-past-history-snapshot.md` | Candidate FI-S04 supplementary file. | Low-authority problem-list/history texture only; not a prednisone source, final diagnosis list, final medication reconciliation, or copy-forward answer file. |
| `worlds/korvin-merrow/supplementary-files/candidate-review/supplementary-file-construction-validation-review.md` | Candidate validation review for FI-S01 through FI-S04. | Verifies architecture alignment, inventory alignment, trap/friction/hierarchy preservation, anti-answer-file protections, FI-W22 incompleteness, and absence of prompts/outputs/goldens/grader guidance/AutoQC/DOCX/submission artifacts. |
