...
87. `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-v1.md` for active Grader Guidance Architecture candidate.
88. `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-validation-review.md` for active Grader Guidance Architecture validation review.
89. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
90. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
91. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active Grader Guidance Architecture v1 artifacts awaiting review or lock.
- `locked/`: future locked grader-guidance architecture artifacts after ratification.
- `ratifications/`: future ratification records for Grader Guidance Architecture.
...
| File | Role | Duplication note |
| --- | --- | --- |
| `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-v1.md` | Active candidate architecture for future grader guidance. | Defines GG-KM01 through GG-KM06 count, IDs, TP/EO/Golden mapping, grading philosophy, acceptable/unacceptable-answer principles, reasoning dimensions, hierarchy/friction/uncertainty expectations, and boundary protections. It does not create actual grader guidance, scoring rubrics, scoring thresholds, AutoQC responses, DOCX artifacts, or submission artifacts. |
| `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-validation-review.md` | Active candidate validation review for Grader Guidance Architecture v1. | Verifies alignment with locked goldens, expected outputs, prompts, governance, file dependencies, hierarchy rules, multi-path defensibility, and prohibited-artifact boundaries. It is not grader guidance, a scoring rubric, an AutoQC response, a DOCX artifact, or a submission artifact. |
