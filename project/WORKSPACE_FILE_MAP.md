...
43. `worlds/korvin-merrow/task-setup/task6/TASK6-STATE.md` for KM06 state. Current live status: KM06 Ready for Delivery; prior PL planner/backups are preserved as evidence.
44. `worlds/korvin-merrow/task-setup/task6/preference-labeling/` for local KM06 PL planner and three PL backups. Evidence/support only now that KM06 is RFD.
45. `worlds/korvin-merrow/task-setup/task7/TASK7-STATE.md` for KM07 live state. Current staged concept is a nephrology referral-letter task, built for variety and staged locally, but blocked waiting on EDM input.
