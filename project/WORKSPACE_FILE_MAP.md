...
20. `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md` for KM03 FA/GA provenance. Pre-Sang Attempt 9 draft is superseded; post-Sang platform entry uses Attempt 4 (0.30), and FA/GA AutoQC is running.
...
28. `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md` for KM04 FA/GA provenance. Pre-Sang Attempt 5 draft is superseded; post-Sang platform entry uses Attempt 9 (0.30), and FA/GA AutoQC is running.
...
- `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md`: KM03 FA/GA provenance. Pre-Sang Attempt 9 draft is superseded; post-Sang platform entry uses Attempt 4 (0.30), FA/GA AutoQC is running, and no PL or final review exists yet.
...
- `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md`: KM04 FA/GA provenance. Pre-Sang Attempt 5 draft is superseded; post-Sang platform entry uses Attempt 9 (0.30), FA/GA AutoQC is running, and no PL or final review exists yet.
...
6/8 late KM03 post-fix rerun update: KM03 rerun job `8e97cdd7` is complete after the Sang grader/golden fix. Spread: 80, 62, 90, 30, 90, 88, 82, 87, 85, 70; mean 76.4; single lowest Attempt 4 / run `c2eea662` at 0.30. `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md` now supersedes the pre-fix `877aa204` Attempt 9 draft. Alexander later completed platform FA/GA entry on Attempt 4; FA/GA AutoQC is running.

6/8 late KM04 post-fix rerun update: KM04 rerun job `979dccde` is complete after the Sang grader/golden fix. Spread: 95, 90, 30, 88, 78, 88, 90, 35, 30, 40; mean 66.4; lowest score 0.30 shared by Attempts 3 and 9; Attempt 9 / run `976b2b18` selected for FA/GA, with Attempt 1 / run `06d0b710` at 0.95 as catch anchor. `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md` now supersedes the pre-fix `709be0e8` Attempt 5 draft. Alexander later completed platform FA/GA entry on Attempt 9; FA/GA AutoQC is running. KM03 and KM04 both now have post-fix local FA/GA drafts; platform FA/GA entry is recorded in the next line. No PL or final review exists yet.

6/8 late KM03/KM04 FA-GA platform entry: Alexander entered both FA/GA records on platform. KM03 uses Attempt 4 (0.30), FA 787 chars, GA 749 chars. KM04 uses Attempt 9 (0.30), FA 902 chars, GA 807 chars. FA/GA AutoQC is running for both. Next step: clear FA/GA AutoQC, then three Preference Labels per task with PL AutoQC after each, then final review. No PL or final-review artifact exists yet.
