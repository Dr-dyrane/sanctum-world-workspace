...
43. `worlds/korvin-merrow/synthetic-files/candidate-review/batch-3/batch-3-validation-review.md` for Batch 3 candidate review status.
44. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
45. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
46. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active synthetic-file construction artifacts awaiting physician review or lock. Currently contains Batch 3 candidate files FI-W14 through FI-W16 and the Batch 3 validation review.
...
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-3/FI-W14_nephrology-consultation-documentation.md` | Candidate synthetic world-level file FI-W14. | Nephrology consultation documentation only; not a discharge summary, not a final medication plan, and not an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-3/FI-W15_cardiology-consultation-documentation.md` | Candidate synthetic world-level file FI-W15. | Cardiology consultation documentation only; not a final GDMT restart plan and not an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-3/FI-W16_endocrinology-consultation-documentation.md` | Candidate synthetic world-level file FI-W16. | Endocrinology consultation documentation only; not proof of adrenal insufficiency, not a final steroid taper, and not an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-3/batch-3-validation-review.md` | Candidate validation review for Batch 3 FI-W14 through FI-W16. | Review artifact only; not a synthetic chart file, task prompt, golden, grader guidance, AutoQC response, or submission artifact. |
