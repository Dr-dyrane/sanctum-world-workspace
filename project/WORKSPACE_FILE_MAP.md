...
13. `worlds/korvin-merrow/task-setup/platform/task3/current/` for the KM03 v2.1 platform set retained as evidence after job `58b5f3e3` difficulty failure.
...
15. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02-BAR-PLAN.md` for the current primary KM03 v2.2 review packet. It proposes the OSA/CPAP fabricated-objective-result mechanism and authorizes no build, platform staging, upload, AutoQC, Taiga, DOCX mutation, or locked-canon edit.
16. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02bar-review-request-for-claude-ai.md` for the self-contained Claude.ai review request paired to the KM02-bar plan. Review-only; no platform or DOCX artifacts authorized.
...
- `worlds/korvin-merrow/task-setup/task3/TASK3-STATE.md`: Task 3 current-state cockpit. KM03 escalation is difficulty-failed through v2.1; job `58b5f3e3` scored 90-97 with zero sub-70. The cockpit preserves the transcript-lineage caveat and points to v2.2 redesign review.
- `worlds/korvin-merrow/task-setup/task3/KM03-state-log.md`: Task 3 live event log for build, AutoQC, and run-state changes. Current event: job `58b5f3e3` is recorded as the KM03 v2.1 difficulty failure, with v1-era artifact naming caveat preserved.
...
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02-BAR-PLAN.md`: Current primary KM03 v2.2 review packet. Supersedes the Lenora supervision-fact plan as primary and proposes the OSA/CPAP fabricated-objective-result mechanism. Review-only; no DOCX, upload, AutoQC, Taiga, platform staging, or locked-canon mutation authorized.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02bar-review-request-for-claude-ai.md`: Self-contained Claude.ai review request for the KM03 v2.2 KM02-bar plan. Review-only; no DOCX, upload, AutoQC, Taiga, platform staging, or locked-canon mutation authorized.
...
- `worlds/korvin-merrow/task-setup/platform/task3/current/`: KM03 v2.1 platform set retained as evidence after difficulty failure. Contains writer-owned prompt `prompt-task3-v2.txt`, mounted draft `care_coordination_handoff_draft_05242026.docx` (`f3b7bcdf`), golden `golden-KM03-v2.docx` (`3da7386f`), grader `grader-guidelines-task3-v2.txt`, and local `RUN-INSTRUCTIONS.md`. Do not proceed to FA/GA, PL, final review, rerun AutoQC, rerun agents, rerun QA, upload additional files, or mutate RL Studio without exact Alexander authorization.
