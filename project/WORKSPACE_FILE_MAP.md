...
Status: active. Task 1 is in Taiga QA feedback / pre-FA-GA after corrective v4 rerun; Tasks 2-6 remain in preparation.
Current contents:
...
- Do not start Failure Analysis / Grader Analysis, preference labeling, additional task uploads, additional agent runs, additional QA runs, create AutoQC responses, create scoring artifacts, or mutate RL Studio from this folder without explicit authorization. Current next platform sequence is Task 1 DQ `tech issue` response, 5.1 Taiga QA Feedback AutoQC, 5.2 clearance, then FA/GA.
