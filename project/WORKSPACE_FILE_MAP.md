...
113. `worlds/korvin-merrow/execution-preparation/candidate-review/execution-preparation-v1.md` for active Execution Preparation v1 candidate review.
114. `worlds/korvin-merrow/execution-preparation/candidate-review/execution-preparation-validation-review.md` for active Execution Preparation validation review.
...
- `candidate-review/` is reserved for active candidate artifacts only. Inactive candidate-review folders should be absent from the visible tree and recreated on demand when a new candidate artifact exists. The active candidate-review folder is `worlds/korvin-merrow/execution-preparation/candidate-review/`.
...
- `candidate-review/`: active Execution Preparation v1 candidate artifacts.
- `locked/`: absent unless Execution Preparation is later ratified and locked.
- `ratifications/`: absent unless Execution Preparation is later ratified.
...
| File | Role | Duplication note |
| --- | --- | --- |
| `worlds/korvin-merrow/execution-preparation/candidate-review/execution-preparation-v1.md` | Candidate Execution Preparation v1 package. | Records execution readiness, dependency, external-system, authorization, stop-point, and final execution-order registers. It does not perform execution, run AutoQC, populate DOCX, create a manifest, upload, submit, modify locked artifacts, or create scoring artifacts. |
| `worlds/korvin-merrow/execution-preparation/candidate-review/execution-preparation-validation-review.md` | Candidate validation review for Execution Preparation v1. | Verifies coverage of the twelve readiness surfaces, required registers, transcript/template/reference evidence handling, and prohibited-artifact boundaries. |
