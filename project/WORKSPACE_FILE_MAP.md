...
23. `worlds/korvin-merrow/world-spec-prep/candidate-review/provider-roster-package-v1.md` for the active provider roster candidate under physician review.
24. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
25. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions.
26. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/` is reserved for active candidate artifacts only. Task Architecture Interview v1 moved to `planning-scaffolds/` after Task Architecture Package v1 lock. Provider Roster Package v1 is the current active candidate.
...
- `candidate-review/`: artifacts awaiting physician decision or lock. Currently contains Provider Roster Package v1 as the active candidate artifact.
...
| `worlds/korvin-merrow/world-spec-prep/candidate-review/provider-roster-package-v1.md` | Active candidate provider/care-team and stakeholder architecture. | Candidate review only; does not create provider-authored notes, file inventory, task prompts, expected outputs, goldens, grader guidance, medication schedules, hospital-course events, labs, vitals, World Spec prose, templates, reference files, or synthetic documents. |
