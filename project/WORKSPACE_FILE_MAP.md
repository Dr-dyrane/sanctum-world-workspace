...
41. `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/batch-2-validation-review.md` for active Batch 2 candidate-review status.
42. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
43. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
44. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active synthetic-file construction artifacts awaiting physician review or lock. Currently contains Batch 2 FI-W08 through FI-W13.
...
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W08_hd1-hd2-hospitalist-progress-documentation.md` | Candidate synthetic world-level file FI-W08. | HD1-HD2 hospitalist progress documentation only; not locked, not a final discharge summary, not a task prompt, and not a grader artifact. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W09_hd3-hospitalist-progress-documentation.md` | Candidate synthetic world-level file FI-W09. | HD3 hospitalist progress documentation only; not locked, not a final functional source, not a task prompt, and not a grader artifact. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W10_hd4-hospitalist-progress-documentation.md` | Candidate synthetic world-level file FI-W10. | HD4 hospitalist progress documentation only; preserves FI-W06 HD4 availability and is not locked or an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W11_hd5-hd6-hospitalist-discharge-planning-progress-documentation.md` | Candidate synthetic world-level file FI-W11. | HD5-HD6 pre-close discharge-planning progress documentation only; not locked, not a completed discharge outcome, and not a final medication plan. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W12_objective-renal-infection-hemodynamic-trend-summary-source.md` | Candidate synthetic world-level file FI-W12. | Objective trend source only; not locked, not a final infection-source answer, and not a discharge-readiness decision. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/FI-W13_medication-administration-inpatient-medication-action-source.md` | Candidate synthetic world-level file FI-W13. | MAR/inpatient medication action source only; not locked, not a discharge medication list, and not a final restart plan. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-2/batch-2-validation-review.md` | Candidate validation review for Batch 2 FI-W08 through FI-W13. | Review artifact only; not a synthetic chart file, task prompt, golden, grader guidance, AutoQC response, or submission artifact. |
