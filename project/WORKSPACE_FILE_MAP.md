...
115. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
116. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
117. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active Transcript Resolution v1 candidate artifacts.
- `locked/`: absent unless Transcript Resolution is later ratified and locked.
- `ratifications/`: absent unless Transcript Resolution is later ratified.
...
| File | Role | Duplication note |
| --- | --- | --- |
| `worlds/korvin-merrow/transcript-resolution/candidate-review/transcript-resolution-v1.md` | Candidate Transcript Resolution v1 package. | Records current Studio file-upload evidence, stale-video supersession, unresolved transcript format/scope dependencies, and boundary preservation. It does not format, convert, package, upload, or submit transcript materials. |
| `worlds/korvin-merrow/transcript-resolution/candidate-review/transcript-resolution-validation-review.md` | Candidate validation review for Transcript Resolution v1. | Verifies alignment with Execution Preparation, source-derived transcript guidance, current Studio screenshot evidence, stale-video limits, and prohibited-artifact boundaries. |
