...
Current status: World Spec APPROVED after RL Studio upload, Spec AutoQC, and Stacey S Human World Spec Review. Final AutoQC board is 108/109 with the sole open flag, prednisone dose/frequency, intentionally note-justified as the central source-of-truth trap. Engineering pipeline run #1 and Step 9 generated-file review are complete: Final Files AutoQC passed 78/78 after three revisions, and `Healthcare_247_Merrow` was created 2026-06-05 11:20 AM PDT (`world_d50c832ac6474a68ba982a77e28a6bbe`, snapshot `snap_0fb032e95b324710b12a7432cf7da6c1`, 26 files synced). Task 1 final human review is complete / approved. Task 2 / KM02 is COMPLETE / RFD (Ready for Delivery) after Janette's 6/8 final review: golden `golden-KM02-v5.docx` is re-dated to 05/24/2026 with sha256 prefix `2dd3e0ad`, Task AutoQC / Taiga gates passed qcaud_5e, qcaud_4a, and qcaud_ef, final FA/GA uses Attempt 8 at 0.30 from v3 job `8f393839`, and Preference Labels were submitted with verdict B / B++. Task 3 / KM03 escalation through v2.1 is difficulty-failed: job `58b5f3e3` scored 90-97 (mean about 93.6), zero sub-70; the run record notes a lineage caveat because captured transcripts show v1-era filenames/audit prompt/golden-v1. Task 3 / KM03 v2.2 then cleared the difficulty gate after Taiga job `877aa204`: scores 20, 25, 32, 68, 83, 85, 90, 95, 95, 97; mean 69.0; four sub-70 runs and six sub-90 runs. KM03 grading transcripts are verified clean; a local FA/GA drafting packet exists; post-Sang FA/GA entry uses Attempt 4 (0.30), FA/GA AutoQC passed, and KM03 PL #1-#3 drafts exist locally. KM03 is now in PL prep with local PL #1-#3 drafts; no KM03 PL has been platform-submitted. Task 4 / KM04 v1 failed the 6/8 trajectory difficulty gate after Alexander-operated Run All QA job `55ee209f-c9fa-4a64-8071-70d8917508da`: all 10 runs scored 0.87-0.95, mean 0.912, zero sub-70, with no intended significant clinical failure. Record: `worlds/korvin-merrow/task-setup/task4/runs/KM04-taiga-results-55ee209f.md`. Task 4 / KM04 v2 then cleared the difficulty gate after job `709be0e8`: mean 0.689, three sub-70 runs, tail 0.15; records are `worlds/korvin-merrow/task-setup/task4/runs/KM04-v2-taiga-results-709be0e8.md`, `worlds/korvin-merrow/task-setup/task4/runs/KM04-v2-grading-transcripts-709be0e8.md`, and `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md`. Task 5 / KM05 has local prebuild review convergence and a v2 review-only design plan under `worlds/korvin-merrow/task-setup/task5/`; it is not build-ready, not platform-staged, not uploaded, not AutoQC-run, and not agent-run. Locked and complete layers include World Spec v1, File Inventory Architecture v1, File Inventory v1, World-Level Synthetic File Layer FI-W01 through FI-W22, Task-Level Context Files FI-T01 through FI-T07, Supplementary Files FI-S01 through FI-S04, the Entire File Ecosystem, Task Prompt Architecture v1, Task Prompts TP-KM01 through TP-KM06, Expected Output Architecture v1, Expected Outputs EO-KM01 through EO-KM06, Golden Architecture v1, Golden-KM01 through Golden-KM06, Grader Guidance Architecture v1, GG-KM01 through GG-KM06, AutoQC Architecture v1, AutoQC Construction v1, Packaging Architecture v1, Packaging Construction, Submission Preparation, Execution Preparation, and Transcript Resolution. Submission-facing DOCX/PDF artifact generation is complete/canonicalized under `korvin-merrow-final-submission-staging/`.

KM04 update 6/8: v1 difficulty failure remains canonical run evidence, and v2 cleared the difficulty gate after job `709be0e8` (mean 0.689, three sub-70, tail 0.15). Durable v2 records are `worlds/korvin-merrow/task-setup/task4/runs/KM04-v2-taiga-results-709be0e8.md`, `worlds/korvin-merrow/task-setup/task4/runs/KM04-v2-grading-transcripts-709be0e8.md`, and `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md`. Current lead axis is anemia-of-CKD / absent iron-workup propagation. platform FA/GA entry is now recorded below; no submitted PL, final review, locked-canon edit, or live-world edit exists.
...
KM05 update 6/8: prebuild review is reset under the no-moderate directive. Start from `worlds/korvin-merrow/task-setup/task5/TASK5-STATE.md`, `task5/design/KM05-v2-design-plan-6-8.md`, and `task5/build-phase-drafts/KM05-v2-review-request-for-claude-ai.md`. The older 6/7 Claude/Codex convergence files remain review history only because their moderate fallback is retired. The v2 lead hypothesis is a cold home-health-start / completed medication-review / good-adherence interval-observation claim inside a transition-clinic draft; renal-BMP is backup only. No KM05 DOCX build, platform-current staging, RL Studio upload, Task AutoQC, Taiga trajectories, QA, or platform mutation has occurred.
...
KM03 v2.2 platform / Taiga update 6/8: active platform files are `worlds/korvin-merrow/task-setup/platform/task3/current/prompt-task3-v2.2.txt`, `worlds/korvin-merrow/task-setup/platform/task3/current/discharge_planning_summary_draft_05242026.docx`, `worlds/korvin-merrow/task-setup/platform/task3/current/golden-KM03-v2.2.docx`, and `worlds/korvin-merrow/task-setup/platform/task3/current/grader-guidelines-task3-v2.2.txt`. Task AutoQC passed 36/36 (`qcaud_fc`). Taiga job `877aa204` cleared the difficulty gate (mean 69.0, four sub-70, six sub-90). Durable result record: `worlds/korvin-merrow/task-setup/task3/runs/KM03-v2.2-taiga-results-877aa204.md`. No platform FA/GA submission, PL, final review, additional upload, or AutoQC response exists; the local FA/GA drafting packet is `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-FAGA-packet-for-claude-ai.md`, and the verified local FA/GA current draft is `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md`. The older v2.1 files live under `platform/task3/archive/v2.1-difficulty-failed-after-58b5f3e3/`; for active KM03 work use the v2.2 filenames.
...
5. `worlds/korvin-merrow/task-setup/task2/fa-ga/FA-GA-current.md` for the submitted / Abi-approved Attempt 8 FA/GA local copy.
...
12. `worlds/korvin-merrow/task-setup/task3/runs/KM03-taiga-results-58b5f3e3.md` for the KM03 trajectory result recorded as v2.1 difficulty failure, with transcript-lineage caveat. Tarballs in `task3/runs/` are local ignored transcript evidence.
13. `worlds/korvin-merrow/task-setup/task3/runs/KM03-v2.2-taiga-results-877aa204.md` for the KM03 v2.2 trajectory result that cleared the difficulty gate.
14. `worlds/korvin-merrow/task-setup/task3/runs/KM03-v2.2-grading-transcripts-877aa204.md` for the KM03 v2.2 grading-transcript verification record; it sets FA/GA subject Attempt 9 (0.20) and GA cross-check Attempt 8 (0.97).
15. `worlds/korvin-merrow/task-setup/platform/task3/current/` for the active KM03 v2.2 set (`prompt-task3-v2.2.txt`, `discharge_planning_summary_draft_05242026.docx`, `golden-KM03-v2.2.docx`, `grader-guidelines-task3-v2.2.txt`). V2.1 evidence lives under `platform/task3/archive/v2.1-difficulty-failed-after-58b5f3e3/`.
16. `worlds/korvin-merrow/task-setup/task3/KM03-3rd-reader-review-and-build-gates.md` plus `task3/build-phase-drafts/01-build-phase-review-responses.md` for the gate history and completion-frame draft response.
17. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02-BAR-PLAN.md` for the current primary KM03 v2.2 mechanism source. It defines the tuned OSA/CPAP fabricated-objective-result mechanism used by the active v2.2 platform set.
18. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02bar-review-request-for-claude-ai.md` for the self-contained Claude.ai review request paired to the KM02-bar plan. Its review outcome is folded into the active v2.2 platform set.
19. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-FAGA-packet-for-claude-ai.md` for the self-contained local FA/GA drafting packet. It is not a platform FA/GA artifact.
20. `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md` for KM03 FA/GA provenance. Pre-Sang Attempt 9 draft is superseded; post-Sang platform entry uses Attempt 4 (0.30), and FA/GA AutoQC passed.
21. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-FINAL-PLAN.md` for the superseded Lenora supervision-fact review packet. Review history only unless Alexander re-selects it.
22. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-reconciliation-6-8.md` for the superseded Lenora decision note plus no-moderate correction. Review history only unless Alexander re-selects that mechanism.
23. `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/` for draft G1-G3 closure review material and superseded v2.2 planning only; not platform-current artifacts.
24. `worlds/korvin-merrow/task-setup/task4/TASK4-STATE.md` for KM04 v1 difficulty-failed state, KM04 v2 difficulty-cleared state, FA/GA draft status, boundaries, and next gates.
25. `worlds/korvin-merrow/task-setup/task4/runs/KM04-taiga-results-55ee209f.md` for the 6/8 trajectory result showing KM04 v1 is too easy.
...
28. `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md` for KM04 FA/GA provenance. Pre-Sang Attempt 5 draft is superseded; post-Sang platform entry uses Attempt 9 (0.30), and FA/GA AutoQC passed.
...
43. `worlds/korvin-merrow/task-setup/task6/TASK6-STATE.md` for KM06 live state. Current live status: Abi approved KM06 and moved it to Preference Labeling on 2026-06-09; local PL drafts exist, but platform PL submission and PL AutoQC remain Alexander-operated steps.
44. `worlds/korvin-merrow/task-setup/task6/preference-labeling/` for local KM06 PL planner and three draft PL backups. Draft/support only until Alexander submits them.
45. `worlds/korvin-merrow/task-setup/task7/TASK7-STATE.md` for KM07 live state. Current staged concept is a nephrology referral-letter task, built for variety and staged locally.
46. `worlds/korvin-merrow/task-setup/platform/task7/current/` for the KM07 staged upload set: prompt, golden DOCX, grader, and RUN-INSTRUCTIONS. No mounted draft is used for the current referral-letter version.
47. `worlds/korvin-merrow/task-setup/platform/task7/archive/2026-06-09-fallbundle-completion-genre-parked/` for the parked fall-bundle completion-genre version. Historical/support only; do not upload from archive without exact authorization.
48. `worlds/korvin-merrow/task-setup/task8/TASK8-STATE.md` for KM08 live state. Current finding: inpatient-vs-observation v3 piloted too easy, job `04270757`, mean about 96.4, zero sub-90; do not ship v3 as-is.
49. `worlds/korvin-merrow/task-setup/task8/design/` for KM08 next-decision planning after the too-easy v3 pilot.
50. `worlds/korvin-merrow/task-setup/task8/guidance/` for KM08 guidance/current and superseded local build support files. The local `files.zip` in this folder is ignored by `.gitignore` and not repository canon.
51. `worlds/korvin-merrow/task-setup/platform/task8/current/` for the retained v3 platform set that piloted too easy. Retained as evidence; not shippable as-is.
52. `worlds/korvin-merrow/task-setup/platform/task8/archive/` for superseded KM08 platform versions.
53. `worlds/korvin-merrow/task-setup/platform/task1/` for live Task 1 platform artifacts.
54. `worlds/korvin-merrow/task-setup/platform/task1/archive/` only for historical Task 1 iterations.
...
| `docs/grader-guidelines-lessons.md` | Sang/Trigeminus reviewer lessons for grader-guidelines structure and length. | Required before editing or reviewing task grader guidelines; governs artifact shape, not clinical canon. |
...
Status: Task 1 final human review complete / approved. Task 1 AO rework, hardening, Abi pre-check, revised platform entry, pilot runs, FA/GA, Preference Labeling, and final review are complete. Task 2 / KM02 is COMPLETE / RFD (Ready for Delivery) after Janette's 6/8 final review (post reseed/date fix); Task AutoQC / Taiga gates passed qcaud_5e, qcaud_4a, and qcaud_ef, final FA/GA uses Attempt 8 at 0.30 from v3 job `8f393839`, and submitted PL evidence lives under `task2/preference-labeling/`. KM03 v2.1 is recorded as difficulty-failed after job `58b5f3e3`; active KM03 v2.2 platform files are in `platform/task3/current/`, Task AutoQC passed 36/36 (`qcaud_fc`), and Taiga job `877aa204` cleared the difficulty gate. KM03 post-Sang rerun job `8e97cdd7` selected Attempt 4 (0.30); Alexander entered FA/GA on platform and FA/GA AutoQC passed. KM04 v1 completed trajectory evidence on 6/8 and failed the difficulty gate: job `55ee209f`, 10 runs 0.87-0.95, mean 0.912, zero sub-70. KM04 v2 cleared the initial difficulty gate after job `709be0e8`; post-Sang rerun job `979dccde` selected Attempt 9 (0.30); Alexander entered FA/GA on platform and FA/GA AutoQC passed. KM05 is review-only reset / HOLD under `task5/` with the cold home-health lead review request and remains held before any build, platform staging, upload, AutoQC, agent run, or QA. Further platform actions remain under Alexander's direct operation. Task 6 remains held unless Alexander explicitly authorizes bounded parallel prep or the next pod-directed task step.
Current contents:
...
- `worlds/korvin-merrow/task-setup/task2/fa-ga/FA-GA-current.md`: submitted / Abi-approved KM02 FA/GA local copy using Attempt 8 / score 0.30 from v3.
- `worlds/korvin-merrow/task-setup/task2/preference-labeling/`: Task 2 Preference Labeling evidence packet. Contains A 0.40 vs B 0.82 transcript evidence, byte evidence, RLS PL instruction excerpt, Task 1 house-format reference, submitted B / B++ verdict backup, and `inputs/` copies of the KM02 v3 prompt/golden/grader/mounted draft matching `platform/task2/current/` by hash. The local `PL-instructions.md` now records Abi's pinned 6/7 update that KM03 onward requires three separate A/B Preference Labels on three different trajectories. Evidence only unless Alexander authorizes resubmission or reviewer-directed edits.
...
- `worlds/korvin-merrow/task-setup/task3/TASK3-STATE.md`: Task 3 current-state cockpit. KM03 v2.1 is difficulty-failed; active v2.2 cleared the difficulty gate after Task AutoQC PASS (`qcaud_fc`) and Taiga job `877aa204`; grading transcripts are verified clean.
- `worlds/korvin-merrow/task-setup/task3/KM03-state-log.md`: Task 3 live event log for build, AutoQC, and run-state changes. Current event: v2.2 platform set is active/current, AutoQC passed, Taiga job `877aa204` cleared the difficulty gate, and grading transcripts are verified clean.
- `worlds/korvin-merrow/task-setup/task3/runs/KM03-taiga-results-58b5f3e3.md`: Durable KM03 trajectory result record. Per Alexander it records the KM03 v2.1 difficulty failure (10 runs all 90-97), while noting captured transcripts carry v1-era filename/prompt/golden-v1 signals. The `.tar.gz` transcript archives in this folder are ignored/local evidence.
- `worlds/korvin-merrow/task-setup/task3/runs/KM03-v2.2-taiga-results-877aa204.md`: Durable KM03 v2.2 trajectory result record. Job `877aa204` cleared the difficulty gate with mean 69.0, four sub-70 runs, and a tail to 0.20.
- `worlds/korvin-merrow/task-setup/task3/runs/KM03-v2.2-grading-transcripts-877aa204.md`: Durable KM03 v2.2 grading-transcript verification record. It confirms the intended CPAP-propagation failure axis, sets Attempt 9 (0.20) as FA/GA subject, and sets Attempt 8 (0.97) as GA cross-check anchor.
...
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/`: Task 3 draft G1-G3 closure packet and v2.2 redesign planning for review only. Tracks source drafts, mount manifests, pilot preregistration, review responses, copied inputs, strategy drafts, and Claude.ai review requests; ZIP bundles in this folder are ignored.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02-BAR-PLAN.md`: Current primary KM03 v2.2 mechanism source. Supersedes the Lenora supervision-fact plan as primary and defines the tuned OSA/CPAP fabricated-objective-result mechanism used by the active v2.2 platform set.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-KM02bar-review-request-for-claude-ai.md`: Self-contained Claude.ai review request for the KM03 v2.2 KM02-bar plan. Review outcome has been folded into the active v2.2 platform set.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-FAGA-packet-for-claude-ai.md`: Self-contained local FA/GA drafting packet for Claude.ai. It is not a platform FA/GA artifact, PL, final review, upload, or RL Studio mutation.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-golden-clinical-register-guide.md`: Local clinical-register guide for Alexander's future KM03 golden wording polish. Support only; not golden text, not a DOCX build, not an upload artifact, and not platform-entered.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/grader-guidelines-task3-RESTRUCTURED.txt`: Local section-mapped grader helper used to align KM03 FA/GA reasoning with the active v2.2 grader. Draft/support only; not a platform-current grader replacement, upload artifact, AutoQC response, PL, or final review.
- `worlds/korvin-merrow/task-setup/task3/fa-ga/FA-GA-current.md`: KM03 FA/GA provenance. Pre-Sang Attempt 9 draft is superseded; post-Sang platform entry uses Attempt 4 (0.30), FA/GA AutoQC passed, and PL is now active.
- `worlds/korvin-merrow/task-setup/task3/preference-labeling/KM03-PL1-A-vs-B.md`: Local KM03 Preference Label 1 draft for the Studio-selected A 0.900 vs B 0.880 pair. Verdict draft is A1 / plain A. Draft only until Alexander submits it.
- `worlds/korvin-merrow/task-setup/task3/preference-labeling/KM03-PL2-A-vs-B.md`: Local KM03 Preference Label 2 draft for A 0.820 vs B 0.620. Verdict draft is A1 / plain A. Draft only until Alexander submits it.
- `worlds/korvin-merrow/task-setup/task3/preference-labeling/KM03-PL3-A-vs-B.md`: Local KM03 Preference Label 3 draft for A 0.820 vs B 0.880. Verdict draft is A1 / plain A. Draft only until Alexander submits it.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-FINAL-PLAN.md`: Superseded KM03 v2.2 Lenora supervision-fact review packet. Historical/reference unless Alexander re-selects this mechanism.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-reconciliation-6-8.md`: Superseded Lenora decision note plus no-moderate correction. Historical/reference unless Alexander re-selects this mechanism.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-strategy-draft.md`: Superseded KM03 v2.2 mechanism-redesign strategy. Historical/reference only; not a platform artifact.
- `worlds/korvin-merrow/task-setup/task3/build-phase-drafts/KM03-v2.2-review-request-for-claude-ai.md`: Superseded Claude.ai review packet for the earlier KM03 v2.2 idea. Historical/reference only; no DOCX, upload, AutoQC, Taiga, or locked-canon mutation authorized.
...
- `worlds/korvin-merrow/task-setup/platform/task3/current/`: KM03 platform-current folder. Active v2.2 set is `prompt-task3-v2.2.txt`, `discharge_planning_summary_draft_05242026.docx`, `golden-KM03-v2.2.docx`, and `grader-guidelines-task3-v2.2.txt`; Task AutoQC passed 36/36 (`qcaud_fc`) and Taiga job `877aa204` cleared the difficulty gate. Do not proceed to FA/GA, PL, final review, rerun Taiga, rerun AutoQC, rerun agents, rerun QA, upload additional files, or mutate RL Studio without exact Alexander authorization.
- `worlds/korvin-merrow/task-setup/platform/task3/archive/v2.1-difficulty-failed-after-58b5f3e3/`: KM03 v2.1 evidence archived after difficulty failure. Contains `prompt-task3-v2.txt`, `care_coordination_handoff_draft_05242026.docx` (`f3b7bcdf`), `golden-KM03-v2.docx` (`3da7386f`), and `grader-guidelines-task3-v2.txt`.
- `worlds/korvin-merrow/task-setup/task4/TASK4-STATE.md`: Task 4 cockpit. Records KM04 v1 trajectory difficulty failure, KM04 v2 difficulty clearance, deterministic source chain, anemia cold-axis propagation mechanism, FA/GA draft status, and boundaries.
- `worlds/korvin-merrow/task-setup/task4/runs/KM04-taiga-results-55ee209f.md`: Durable KM04 v1 trajectory result record. Job `55ee209f-c9fa-4a64-8071-70d8917508da`, completed 2026-06-08, 10 runs scored 0.87-0.95 with mean 0.912 and zero sub-70. Verdict: too easy / difficulty failure; do not advance v1 to FA/GA or PL without explicit override.
...
- `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md`: KM04 FA/GA provenance. Pre-Sang Attempt 5 draft is superseded; post-Sang platform entry uses Attempt 9 (0.30), FA/GA AutoQC passed, and PL is now active.
...
- `worlds/korvin-merrow/task-setup/task4/preference-labeling/KM04-PL1-A-vs-B.md`: Local KM04 Preference Label 1 draft for A 0.400 vs B 0.350. Verdict draft is A1 / plain A. Draft only until Alexander submits it.
- `worlds/korvin-merrow/task-setup/task4/preference-labeling/KM04-PL2-A-vs-B.md`: Local KM04 Preference Label 2 draft for A 0.780 vs B 0.900. Verdict draft is B1 / plain B. Draft only until Alexander submits it.
...
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-plan.md`: Current KM04 v2 review-only redesign plan after v1 difficulty failure. It proposes completion-genre fabricated-objective-result pressure on anemia-of-CKD / absent iron-workup, with nutrition/oral intake demoted to backup / not recommended; not a platform artifact, DOCX, upload record, AutoQC response, Taiga record, prompt, golden, or grader.
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`: Self-contained Claude.ai red-team request for the KM04 v2 plan. Review-only; not a build authorization, platform artifact, DOCX, upload record, AutoQC response, final prompt, golden, grader, FA/GA, PL, or final review.
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-build-proposal.md`: Claude.ai draft build proposal for KM04 v2 after anemia-axis review. Review-only; contains draft prompt/mounted-body/golden/grader concepts and Alexander gates, but is not an upload record, AutoQC response, FA/GA, PL, or final review.
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/grader-guidelines-task4-RESTRUCTURED.txt`: Local section-mapped grader helper after Sang's five-block structure review. Draft/support only; not a platform-current grader replacement, upload artifact, AutoQC response, PL, or final review.
- `worlds/korvin-merrow/task-setup/task4/build-v2/`: Raw local KM04 v2 build set. Contains `prompt-task4-v2.txt`, `interdisciplinary_care_plan_draft_05242026.docx`, `golden-KM04-v2.docx`, `grader-guidelines-task4-v2.txt`, and `RUN-INSTRUCTIONS.md`. Do not upload from this folder; the raw golden copy may preserve the earlier placeholder for provenance.
...
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-claude-ai-review-6-7.md`: Claude.ai independent review of the KM04 build-phase proposal. Verdict GO WITH FIXES; review-only and not a platform artifact, DOCX, upload record, AutoQC response, final prompt, golden, or grader.
- `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-codex-black-team-review-6-7.md`: Codex black-team review of the locally staged KM04 platform set. Verdict GO with no blocker; not a platform upload record, AutoQC response, trajectory result, or final human review.
- `worlds/korvin-merrow/task-setup/platform/task4/current/`: KM04 platform-current local folder. Contains the v2 staged set (`prompt-task4-v2.txt`, `interdisciplinary_care_plan_draft_05242026.docx`, `golden-KM04-v2.docx`, `grader-guidelines-task4-v2.txt`) plus current `RUN-INSTRUCTIONS.md`; this is the v2 set used for current local evidence unless Alexander later replaces it.
- `worlds/korvin-merrow/task-setup/platform/task4/archive/2026-06-08-pre-clean/`: KM04 pre-clean archive preserving v1 evidence plus the transitional v2 files present before current was cleaned to the v2 set. Historical evidence only; do not upload from here.
- `worlds/korvin-merrow/task-setup/task5/TASK5-STATE.md`: Task 5 cockpit. Records the deterministic KM05 source chain, 6/8 no-moderate reset, source audit, proposed early post-discharge follow-up escalation, review gates, and no-build/platform boundaries.
- `worlds/korvin-merrow/task-setup/task5/design/KM05-v2-design-plan-6-8.md`: Current KM05 review-only reset plan. Lead hypothesis is a cold home-health-start / completed medication-review / good-adherence interval-observation claim inside a transition-clinic draft; renal-BMP is backup only. No build or platform action.
- `worlds/korvin-merrow/task-setup/task5/design/KM05-design-plan-for-review.md`: Task 5 design review packet. Treats locked KM05 task identity as settled and focuses on whether an unsigned transition-clinic pre-chart draft creates a fair, empirically testable failure mode.
- `worlds/korvin-merrow/task-setup/task5/design/KM05-claude-ai-proposal-6-7.md`: Historical Claude.ai KM05 proposal review. Verifies the chart closes at 05/24 and frames KM05 as fair but structurally weaker. Its moderate fallback is superseded by the 6/8 no-moderate directive.
- `worlds/korvin-merrow/task-setup/task5/design/KM05-codex-black-team-6-7.md`: Historical Codex KM05 black-team review. Confirms conceptually GO / HOLD under the older moderate classification. Its moderate fallback is superseded by the 6/8 no-moderate directive.
- `worlds/korvin-merrow/task-setup/task5/KM05-prebuild-review-and-build-gates.md`: Task 5 gate checklist for G0 spine/source read, G1 prompt, G2 golden/grader deltas, G3 mounted pre-chart source, G4 manifest separation, G5 future Mode A DOCX hygiene, G6 pilot preregistration, G7 clinical-register scan, and G8 difficulty prediction. Review only.
- `worlds/korvin-merrow/task-setup/task5/build-phase-drafts/`: Task 5 draft/review packet. Contains copied locked inputs, held-back FI-T05 DOCX copy, byte/source audit, de-telegraphed prompt draft, golden/grader deltas, mounted pre-chart source draft, mount manifests, pilot preregistration, the older `KM05-review-request-for-claude-ai.md`, and current `KM05-v2-review-request-for-claude-ai.md`. Not platform-current artifacts.
- `worlds/korvin-merrow/task-setup/task5/build-phase-drafts/KM05-v2-review-request-for-claude-ai.md`: Self-contained Claude.ai red-team request for the KM05 v2 cold home-health-start / medication-review / good-adherence lead. Review-only; not a build authorization, platform artifact, DOCX, upload record, AutoQC response, prompt, golden, grader, FA/GA, PL, or final review.
...
- Task 1 final human review is complete. Task 2 / KM02 is COMPLETE / RFD (Ready for Delivery) after passing qcaud_5e, qcaud_4a, qcaud_ef, Preference Labeling with submitted verdict B / B++, and Janette's 6/8 final review; KM03 v2.1 failed the difficulty gate after job `58b5f3e3`, and KM03 v2.2 cleared the difficulty gate after job `877aa204`; KM03 post-Sang FA/GA was entered on platform and FA/GA AutoQC passed; KM04 v1 failed the 6/8 trajectory difficulty gate; KM04 v2 cleared the initial difficulty gate, post-Sang FA/GA was entered on platform, and FA/GA AutoQC passed; KM05 is review-only reset / HOLD with active plan `worlds/korvin-merrow/task-setup/task5/design/KM05-v2-design-plan-6-8.md` and is not build-ready. Do not run additional task uploads, additional agent runs, additional QA runs, create AutoQC responses, create scoring artifacts, resubmit preference labels, submit KM03/KM04 PLs, run PL AutoQC, start final review, alter KM04 platform-current files, redesign KM04, build or stage KM05 platform-current files, or mutate RL Studio beyond the exact authorized step without explicit Alexander authorization.


---
6/7 late plus 6/8 archive correction: KM03 v2.1 WAS ACTIVE AFTER ALEXANDER UPLOAD, then difficulty-failed and was archived at platform/task3/archive/v2.1-difficulty-failed-after-58b5f3e3/ (prompt-task3-v2.txt, care_coordination_handoff_draft_05242026.docx, golden-KM03-v2.docx, grader-guidelines-task3-v2.txt, RUN-INSTRUCTIONS.md). v1 remains preserved at platform/task3/archive/v1-retired-after-task-writing-reset/ (uploaded, AutoQC qcaud_6b pass, later job 58b5f3e3 returned too easy, retired after task-writing reset; historical only). Mechanism history: authoring posture over a de-authorized unsigned care-coordination handoff DRAFT; fair failure = promoting the draft unverified completion into a signed physician addendum. Build authority history = KM03-v2.1-LOCKED-build-plan.md. CURRENT: active KM03 v2.2 set is platform/task3/current/ (prompt-task3-v2.2.txt, discharge_planning_summary_draft_05242026.docx, golden-KM03-v2.2.docx, grader-guidelines-task3-v2.2.txt, RUN-INSTRUCTIONS.md). Task AutoQC passed 36/36 (`qcaud_fc`); Taiga job `877aa204` cleared the initial difficulty gate; grading transcripts are verified clean; local FA/GA drafting packet and local FA/GA current draft existed at that stage; later post-Sang rerun/platform FA/GA entry is recorded below. No platform-submitted KM03 PL or final review exists.

6/8: KM04 v1 DIFFICULTY FAILED and KM04 v2 DIFFICULTY CLEARED. V1 job `55ee209f-c9fa-4a64-8071-70d8917508da` completed with scores 0.87-0.95, mean 0.912, zero sub-70; durable record: task4/runs/KM04-taiga-results-55ee209f.md. V2 job `709be0e8` completed with mean 0.689, three sub-70, tail 0.15; durable records: task4/runs/KM04-v2-taiga-results-709be0e8.md and task4/runs/KM04-v2-grading-transcripts-709be0e8.md. Post-Sang FA/GA entry uses Attempt 9 (0.30), FA/GA AutoQC passed, and KM04 PL #1-#2 are drafted locally. Do not submit PLs, run PL AutoQC, start final review, rerun, or redesign without explicit Alexander authorization.

6/8: KM05 NO-MODERATE RESET. Start at task5/TASK5-STATE.md, task5/design/KM05-v2-design-plan-6-8.md, and task5/build-phase-drafts/KM05-v2-review-request-for-claude-ai.md. Older 6/7 convergence material is history only. Proposed v2 mechanism: transition-clinic completion draft with one unsupported cold home-health-start / completed medication-review / good-adherence interval-observation claim; correct answer converts it to a verification target, failure carries it as fact. Renal-BMP is backup only. NOT performed: DOCX build, platform-current staging, RL Studio upload, Task AutoQC, Taiga trajectories, QA, FA/GA, PL, or platform mutation.

6/8 late Sang grader/golden review fix: KM03/KM04 moved to Taiga trajectory rerun after grader/golden revisions. The old KM03 `877aa204` and KM04 `709be0e8` runs remain difficulty evidence, but their FA/GA drafts are historical. Use `docs/grader-guidelines-lessons.md` before any grader work. This gate is now superseded by the post-fix reruns and platform FA/GA entry below.
...
6/8 late KM04 post-fix rerun update: KM04 rerun job `979dccde` is complete after the Sang grader/golden fix. Spread: 95, 90, 30, 88, 78, 88, 90, 35, 30, 40; mean 66.4; lowest score 0.30 shared by Attempts 3 and 9; Attempt 9 / run `976b2b18` selected for FA/GA, with Attempt 1 / run `06d0b710` at 0.95 as catch anchor. `worlds/korvin-merrow/task-setup/task4/fa-ga/FA-GA-current.md` now supersedes the pre-fix `709be0e8` Attempt 5 draft. Alexander later completed platform FA/GA entry on Attempt 9; FA/GA AutoQC passed. KM03 and KM04 both now have post-fix local FA/GA drafts; platform FA/GA entry is recorded in the next line. Local PL draft artifacts are recorded below; no platform-submitted PL or final review exists yet.

6/8 late KM03/KM04 FA-GA platform entry: Alexander entered both FA/GA records on platform. KM03 uses Attempt 4 (0.30), FA 787 chars, GA 749 chars. KM04 uses Attempt 9 (0.30), FA 902 chars, GA 807 chars. FA/GA AutoQC passed for both. PL is now active: KM03 PL #1-#3 are drafted locally under `worlds/korvin-merrow/task-setup/task3/preference-labeling/`; KM03 needs their platform submission, and KM04 PL #1-#2 are drafted locally while KM04 still needs one more PL draft/submission. Run PL AutoQC after each, then final review. Local PL draft artifacts exist as listed; no platform-submitted PL or final-review artifact exists yet.
