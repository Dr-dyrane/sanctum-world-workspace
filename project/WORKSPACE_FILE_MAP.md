...
41. `worlds/korvin-merrow/synthetic-files/locked/batch-2/batch-2-validation-review.md` for locked Batch 2 validation.
42. `worlds/korvin-merrow/synthetic-files/ratifications/batch-2-ratification.md` for Batch 2 lock record.
43. `worlds/korvin-merrow/synthetic-files/locked/batch-3/batch-3-validation-review.md` for locked Batch 3 validation.
44. `worlds/korvin-merrow/synthetic-files/ratifications/batch-3-ratification.md` for Batch 3 lock record.
45. `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/batch-4-validation-review.md` for Batch 4 candidate review status.
46. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
47. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
48. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active synthetic-file construction artifacts awaiting physician review or lock. Currently contains Batch 4 candidate files FI-W17 through FI-W21 and the Batch 4 validation review.
...
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/FI-W17_bedside-nursing-observation-notes-flowsheet-summary.md` | Candidate synthetic world-level file FI-W17. | Bedside nursing observation summary only; not a final disposition decision and not an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/FI-W18_physical-therapy-assessment.md` | Candidate synthetic world-level file FI-W18. | Physical Therapy assessment only; not a final therapy/discharge order and not an answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/FI-W19_occupational-therapy-assessment.md` | Candidate synthetic world-level file FI-W19. | Occupational Therapy assessment only; not a final medication reconciliation, final disposition answer, or answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/FI-W20_family-communication-care-conference-documentation.md` | Candidate synthetic world-level file FI-W20. | Family communication documentation only; not a final disposition decision, steroid answer, or source-of-truth override. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/FI-W21_case-management-social-work-discharge-planning-note.md` | Candidate synthetic world-level file FI-W21. | Case Management / Social Work discharge-planning note only; not a completed discharge plan, final service authorization, or final disposition decision. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-4/batch-4-validation-review.md` | Candidate validation review for Batch 4 FI-W17 through FI-W21. | Review artifact only; not a synthetic chart file, task prompt, golden, grader guidance, AutoQC response, or submission artifact. |
