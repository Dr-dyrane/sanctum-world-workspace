...
47. `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/batch-5-validation-review.md` for active Batch 5 candidate validation.
48. `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/FI-W22_discharge-facing-plan-snapshot-before-world-close.md` for active FI-W22 candidate content.
49. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
50. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
51. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `worlds/korvin-merrow/synthetic-files/` is now a lifecycle folder for synthetic file planning/construction. Synthetic World-Level File Construction Plan v1 is locked and ratified. Batch 1, Batch 2, Batch 3, and Batch 4 synthetic world-level files are locked and ratified. Batch 5 FI-W22 is in candidate review.
- `candidate-review/` is reserved for active candidate artifacts only. Task Architecture Interview v1 moved to `planning-scaffolds/` after Task Architecture Package v1 lock. World Spec prep `candidate-review/` is empty after Daily Hospital Course Framework v1 lock; file-inventory `candidate-review/` is empty after File Inventory v1 lock; synthetic-files `candidate-review/` contains active Batch 5 candidate artifacts only.
...
- `candidate-review/`: active synthetic-file construction artifacts awaiting physician review or lock. Currently contains Batch 5 FI-W22 candidate artifacts.
...
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/FI-W22_discharge-facing-plan-snapshot-before-world-close.md` | Candidate synthetic world-level file FI-W22. | Discharge-facing plan snapshot before world close only; visible and useful but incomplete, not a final discharge summary, final disposition decision, final medication reconciliation, or answer file. |
| `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/batch-5-validation-review.md` | Candidate validation review for Batch 5 FI-W22. | Review artifact only; not a synthetic chart file, task prompt, golden, grader guidance, AutoQC response, submission artifact, or lock ratification. |
