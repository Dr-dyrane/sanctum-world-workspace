...
6. `worlds/korvin-merrow/task-setup/task2/runs/clean-pilot/` for why the clean pilot failed as a difficulty mechanism.
7. `worlds/korvin-merrow/task-setup/platform/task2/README.md` and `platform/task2/current/RUN-INSTRUCTIONS.md` for platform artifact provenance.
8. `worlds/korvin-merrow/task-setup/task2/design/KM02-design-plan-for-review.md` for Task 2 red-team study and discriminator history.
9. `worlds/korvin-merrow/task-setup/task3/TASK3-STATE.md` for Task 3 bounded inheritance state.
