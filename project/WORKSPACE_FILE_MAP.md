...
Status: Task 1 final human review complete / approved. Task 1 AO rework, hardening, Abi pre-check, revised platform entry, pilot runs, FA/GA, Preference Labeling, and final review are complete. Tasks 2-6 remain held unless Alexander explicitly authorizes bounded parallel prep or the next pod-directed task step.
Current contents:
...
- `worlds/korvin-merrow/task-setup/task2/RED-TEAM-BRIEF-KM02.md`: paste-ready KM02 red-team brief for claude.ai review. Directs reviewers to the agent-read world layer and names the v4 golden, prompt draft, canon folder, continuity folder, and bundle contents.
...
- `worlds/korvin-merrow/task-setup/task2/Golden-KM02-v2-DRAFT.md`: historical/rationale markdown for the KM02 golden rebuild and correction trail. Superseded where it conflicts with the v4 source/DOCX correction.
- `worlds/korvin-merrow/task-setup/task2/golden-KM02-source.md`: source markdown for generating the KM02 v4 golden DOCX through `tools/generate_reference_files.py`.
- `worlds/korvin-merrow/task-setup/task2/golden-KM02-v4.docx`: current KM02 red-team golden candidate. Generated from `golden-KM02-source.md` through the Epic-style world-file builder and banner-stripped to match the agent-read uploaded world chrome. Candidate review artifact only; not uploaded.
- `worlds/korvin-merrow/task-setup/task2/KM02-redteam-bundle.zip`: zipped KM02 red-team bundle containing the design plan, prompt draft, v4 golden/source, locked KM02 canon, continuity references, and the agent-read 26-file world snapshot for red-team review. Review source bundle only; not a submission package and not an upload artifact. Supersedes `KM02-review-bundle.zip`.
...
- Task 1 final human review is complete. Do not start Task 2 setup, additional task uploads, additional agent runs, additional QA runs, create AutoQC responses, create scoring artifacts, or mutate RL Studio without explicit authorization.
