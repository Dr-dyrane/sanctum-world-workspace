...
115. `worlds/korvin-merrow/final-submission-resolution/candidate-review/final-submission-resolution-v1.md` for active Final Submission Resolution candidate decisions.
116. `worlds/korvin-merrow/final-submission-resolution/candidate-review/final-submission-resolution-validation-review.md` for active Final Submission Resolution validation review.
117. `worlds/korvin-merrow/world-spec-prep/planning-scaffolds/task-architecture-interview-v1.md` for historical interview basis.
118. `worlds/korvin-merrow/world-spec-prep/decision-logs/physician-decision-log-02.md` for ratified Clinical Story Skeleton decisions and construction-lock status.
119. `reference/world-spec-guidelines/08_autoqc_master_index.md` only when exact AutoQC checks are needed.
...
- `candidate-review/`: active Final Submission Resolution v1 candidate artifacts.
- `locked/`: absent until Final Submission Resolution is reviewed and explicitly locked.
...
| File | Role | Duplication note |
| --- | --- | --- |
| `worlds/korvin-merrow/final-submission-resolution/candidate-review/final-submission-resolution-v1.md` | Active candidate resolution package for final submission dependencies and export architecture. | Defines required/optional/do-not-upload sets, folder mapping, execution inventory, DOCX population blueprint, export matrix, transcript export decision, FI-W/FI-T/FI-S upload boundaries, and stop points. It does not create DOCX/PDF artifacts, manifests, packages, uploads, submissions, AutoQC responses, or scoring artifacts. |
| `worlds/korvin-merrow/final-submission-resolution/candidate-review/final-submission-resolution-validation-review.md` | Active validation review for Final Submission Resolution v1. | Verifies alignment with official template evidence, RL Studio evidence, example package structure, locked Korvin artifacts, Transcript Resolution, source-derived upload inventory, and prohibited boundaries. |
