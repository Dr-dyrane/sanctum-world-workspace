...
Status: active. Task 1 FA/GA is submitted and FA/GA AutoQC is pending; Tasks 2-6 remain in preparation.
Current contents:
...
- `worlds/korvin-merrow/task-setup/task1/FA-GA-final.md`: final submitted Task 1 Failure Analysis and Grader Analysis wording. Platform status: saved on batch v2, run `aef58074`; GA rated Great; remaining gate is FA/GA AutoQC.
Boundaries:
