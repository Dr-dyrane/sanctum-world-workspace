...
export const worlds: World[] = [
  ...
  },
  {
    ...
    blurb: 'Limb-threat diabetic foot world. OV01 clean pilot banked. OV07 is re-centered for the next pilot.',
    meta: {
      patient: 'Ondina Vasquell clinical suite',
      chart: 'Healthcare_297_Vasquell, 34 files, snapshot May 21, 2026 at 18:00',
      writer: 'Alexander Udeogaranya, MD',
      evidence: 'World created. OV01 clean pilot job 741ba52f banked. OV07 v2 ceiling documented and v3 rebuilt locally.',
