...
export const journey = [
  { label:'World idea', status:'complete', detail:'Concept accepted into structured world planning.' },
  { label:'First check', status:'complete', detail:'Priority labels and leakage notes corrected before submission.' },
  { label:'Lead review', status:'complete', detail:'Submission copy built and audited.' },
  { label:'World blueprint', status:'complete', detail:'Case plan, conversation record, and source-file plan prepared.' },
  { label:'Blueprint check', status:'complete', detail:'Current source and tool details patched into the final document.' },
  { label:'Task build', status:'active', detail:'Korvin tasks complete or ready; Ondina task build is next.' },
  { label:'Shareable files', status:'gated', detail:'Only clean, approved files should enter public downloads.' },
];
