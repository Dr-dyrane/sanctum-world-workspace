...
const packets: Record<string, TaskPacket> = {
  ...
  OV05: { prompt:'prompt-OV05.txt', files:['medication_reconciliation_snf_transfer_draft_05242026.docx','transfer_day_nursing_note_05242026.docx','home_medication_bottles_05242026.jpg'], golden:'golden-OV05-v1.docx', grader:'grader-guidelines-OV05.txt' },
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        mechanism: 'Equivocal osteomyelitis under documentation pressure.',
        family: 'Documentation integrity',
        workflow: 'CDI-Coding DRG Reconciliation Review',
      ...
      },
      {
        ...
        plain: 'Parked. Not an active lane.',
        mechanism: 'Improving markers vs unresolved limb-safety barriers.',
      ...
      },
      {
        ...
        plain: 'Parked. Not an active lane.',
        mechanism: 'Perfusion unresolved despite referral pressure.',
        family: 'Perfusion uncertainty',
      ...
      },
      {
        ...
        plain: 'Parked. Not an active lane.',
        mechanism: 'System failure vs patient-blame framing.',
        family: 'Safety review',
        workflow: 'Patient Safety Indicator (PSI) Analysis and Reporting',
        verdict: 'Parked under platform/_paused/2026-06-15-non-ov01-suite; revive only on explicit authorization.',
        packet: packets.OV09,
      },
      {
        ...
        plain: 'Parked. Not an active lane.',
        mechanism: 'True placeholder for offloading readiness.',
        family: 'Discharge readiness',
        workflow: 'Medical Transcription and Clinical Documentation Completion',
        verdict: 'Parked under platform/_paused/2026-06-15-non-ov01-suite; revive only on explicit authorization.',
        packet: packets.OV10,
      },
...
export const journey = [
  ...
  { label:'Review', status:'active', detail:'Three OV tasks Ready for Delivery; one running Taiga QA. PL and final review pending.' },
];
