  ...
  const WORLDS = {
    ...
    'ondina-vasquell': {
      ...
      blurb: 'Healthcare_297_Vasquell is live. OV01 is in review cleanup. FA/GA is ready.',
      driveUrl: null,
      meta: {
        world: 'Project Sanctum',
        ...
        writer: 'Alexander Udeogaranya, MD',
        evidence: 'Brainstorm pass, Spec pass, Final AutoQC clear, world created, OV01 clean pilot job 741ba52f, review rerun job aa949641',
        dataSyncedOn: '2026-06-15',
        provenance: 'OV01 displays the clean pilot and the review-return rerun. Dirty duplicate-mount job 9765ba91 is excluded. FA/GA draft is ready; PL and final review remain pending.',
      },
      tasks: [
        {
          ...plannedTaskBase,
          ...
          quality:'exact',
          reach:'proven',
          provNote:'Clean job 741ba52f mounted one order set, discharge_medication_orders_05212026.docx, under /docs/filesystem. Dirty job 9765ba91 is excluded because it mounted two same-purpose task files. Larry-return rerun aa949641 selects Attempt 6, run 28a61869, score 0.50.',
        },
        {
          ...plannedTaskBase,
          id:'OV07', position:2,
        ...
        },
        {
          ...
          plain:'Retired after repeated coding-attestation ceilings. Do not upload or pilot without a new authorization.',
          ...
          quality:'exact',
          reach:'retired',
          provNote:'v4 and v5 both ceilinged. OV02 is parked under the retired coding-attestation archive and is not an active lane.',
        },
      ],
    },
  };
