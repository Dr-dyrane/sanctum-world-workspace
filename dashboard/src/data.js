  ...
  const CONFIG = {
    ...
    cats: {
      ...
      retired:   { label:'Retired',          pill:'Retired' },
    ...
    reachability: {
      ...
      retired: { label:'Retired',        plain:'The route ceilinged or was withdrawn. It stays visible as evidence, not as a shippable task.' },
    ...
    failureFamilies: {
      ...
      referral: { label:'Referral coordination', plain:'The model follows a subordinate or routine coordination note instead of the chart-governed need.' },
      utilization: { label:'Utilization review', plain:'The model leaves a stay or placement decision unresolved despite a material chart barrier.' },
      measure:  { label:'Measure abstraction', plain:'The model misses a quiet lookback or denominator logic issue.' },
      retired:  { label:'Retired route', plain:'The route ceilinged and should be swapped rather than tuned.' },
  ...
  /* ════════════════════════════════════════════════════════════
     ...
     Synced 2026-06-18. External AQC eval rows are excluded.
     Fields:
       stage        'planned' | 'built' | 'retired' | 'delivered' | 'ready' | 'review'
  ...
  const WORLDS = {
    ...
    'ondina-vasquell': {
      ...
      meta: {
        ...
        provenance: 'Board sync from Healthcare_297_Vasquell and local WORLD-STATUS.md running record.',
      },
      tasks: [
        {
          ...plannedTaskBase,
  ...
  const TASK_PACKETS = {
    ...
    OV05: {
      ...
      files:[
        'started_referral_coordination_note_05252026.docx',
        'home_health_intake_review_05242026.docx',
      ],
      golden:'golden-OV05.docx',
    ...
    OV07: {
      prompt:'prompt-OV07.txt',
      files:[
        'started_appeal_letter_05242026.docx',
        'transfer_day_nursing_note_05242026.docx',
        'wound_photo_05242026.jpg',
      ],
      golden:'golden-OV07-v1.docx',
      grader:'grader-guidelines-OV07.txt',
    },
    OV08: {
      prompt:'prompt-OV08.txt',
      files:['continued_stay_determination_worksheet_05252026.docx'],
      golden:'golden-OV08-v1.docx',
      grader:'grader-guidelines-OV08.txt',
    },
    OV09: {
      prompt:'prompt-OV09.txt',
      files:['started_post_acute_coordination_note_05242026.docx'],
      golden:'golden-OV09.docx',
      grader:'grader-guidelines-OV09.txt',
    },
    OV10: {
      prompt:'prompt-OV10.txt',
      files:[
        'started_discharge_summary_05242026.docx',
        'chronic_disease_management_review_05232026.docx',
      ],
      golden:'golden-OV10.docx',
      grader:'grader-guidelines-OV10.txt',
    },
  };
