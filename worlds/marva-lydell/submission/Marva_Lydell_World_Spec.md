...
Capability: an attending patient-safety review of a complete signed resident note that carries two common, realistic errors the reviewer must catch before sign-off.
Workflow: Peer Review and Patient Safety Documentation Review, requested by the supervising hospitalist attending. New approved-category lane replacing the deprecated completion lane; confirm the verbatim string with the lead.
