...
Current state: Supplementary File Architecture / LOCK READY.
...
- `supplementary-file-architecture/`: supplementary FI-S architecture lifecycle area. Lock-ready candidate architecture defines future FI-S01 through FI-S04 only and does not construct FI-S files.
...
- `supplementary-file-architecture/candidate-review/supplementary-file-architecture-v1.md`
- `supplementary-file-architecture/candidate-review/supplementary-file-architecture-validation-review.md`
