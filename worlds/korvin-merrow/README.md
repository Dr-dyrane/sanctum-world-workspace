...
KM03/KM04 current gate 6/8 late: Sang's Trigeminus review required grader/golden revisions. Both KM03 and KM04 are now AT TAIGA TRAJECTORY RERUN, not ready for FA/GA entry from the old runs. Prior successful spreads (`877aa204` for KM03, `709be0e8` for KM04) remain difficulty evidence only; rerun transcripts must be captured and FA/GA re-derived from the new lowest run before platform FA/GA, FA/GA AutoQC, PL, or final review. Read `docs/grader-guidelines-lessons.md` before any grader work.
