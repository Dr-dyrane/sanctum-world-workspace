...
Current state: Batch 1 Synthetic World-Level File Construction / Locked.
...
- `synthetic-files/`: synthetic file construction lifecycle area. Locked construction plan governs construction order; Batch 1 files are locked.
