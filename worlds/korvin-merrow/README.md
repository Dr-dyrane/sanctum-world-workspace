...
Current state: AutoQC Construction / CANDIDATE REVIEW.
...
- `autoqc/`: AutoQC construction lifecycle area. Candidate artifacts organize future AutoQC execution order and routing only; they do not run AutoQC, create platform responses, create AutoQC responses, create scoring artifacts, create DOCX artifacts, or create submission materials.
...
- `autoqc/candidate-review/autoqc-construction-v1.md`
- `autoqc/candidate-review/autoqc-construction-validation-review.md`
