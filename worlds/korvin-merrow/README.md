...
KM04 v2 update 6/8: current v2 material is planning/review/build-proposal plus raw build copy and local platform-current staging at `task-setup/task4/build-phase-drafts/KM04-v2-plan.md`, `task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`, `task-setup/task4/build-phase-drafts/KM04-v2-build-proposal.md`, `task-setup/task4/build-v2/`, and `task-setup/platform/task4/current/`; v1 evidence is archived at `task-setup/platform/task4/archive/2026-06-08-pre-clean/`. Lead axis is anemia-of-CKD / absent iron-workup propagation; nutrition/oral-intake is backup / not recommended. Platform-current golden v2 has no bracketed placeholder and no DOCX core-metadata leak on read-only check, but still needs Alexander physician review/sign-off. There is no v2 upload, AutoQC, Taiga run, FA/GA, PL, final review, locked-canon edit, or live-world edit.
...
- `task-setup/platform/task4/current/` (local v2 staging; pending Alexander sign-off/upload authorization)
