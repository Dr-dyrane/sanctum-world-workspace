...
Current state: Supplementary File Architecture / CANDIDATE REVIEW.
...
- `supplementary-file-architecture/`: supplementary FI-S architecture lifecycle area. Candidate architecture defines future FI-S01 through FI-S04 only and does not construct FI-S files.
