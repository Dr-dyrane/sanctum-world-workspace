...
Current state: Batch 5 Synthetic World-Level File Construction / Candidate Review.
...
- `synthetic-files/`: synthetic file construction lifecycle area. Locked construction plan governs construction order; Batch 1 through Batch 4 files are locked, and Batch 5 FI-W22 is in candidate review.
...
- `synthetic-files/candidate-review/batch-5/batch-5-validation-review.md`
- `synthetic-files/candidate-review/batch-5/FI-W22_discharge-facing-plan-snapshot-before-world-close.md`
