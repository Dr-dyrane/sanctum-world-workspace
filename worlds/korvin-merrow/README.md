...
Current state: Batch 3 Synthetic World-Level File Construction / Candidate Review.
...
- `synthetic-files/candidate-review/batch-3/batch-3-validation-review.md`
