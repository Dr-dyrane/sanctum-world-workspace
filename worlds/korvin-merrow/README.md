...
KM03 v2.2 platform update 6/8: active pre-Taiga platform files are `task-setup/platform/task3/current/prompt-task3-v2.2.txt`, `task-setup/platform/task3/current/discharge_planning_summary_draft_05242026.docx`, `task-setup/platform/task3/current/golden-KM03-v2.2.docx`, and `task-setup/platform/task3/current/grader-guidelines-task3-v2.2.txt`. Task AutoQC passed 36/36 (`qcaud_fc`); Taiga trajectories are intentionally held. No v2.2 Taiga run, FA/GA, PL, final review, additional upload, or AutoQC response exists.
...
- `task-setup/platform/task3/current/` (active v2.2 pre-Taiga set; use v2.2 filenames)
