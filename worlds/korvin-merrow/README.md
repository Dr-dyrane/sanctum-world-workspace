...
Current state: Batch 2 Synthetic World-Level File Construction / Candidate Review.
...
- `synthetic-files/`: synthetic file construction lifecycle area. Locked construction plan governs construction order; Batch 1 files are locked and Batch 2 files are in candidate review.
...
- `synthetic-files/candidate-review/batch-2/batch-2-validation-review.md`
