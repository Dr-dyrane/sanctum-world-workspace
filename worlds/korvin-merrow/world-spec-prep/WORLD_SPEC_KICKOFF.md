...
Status: Task-Level Context File Construction / CANDIDATE REVIEW.
...
- Candidate task-context files: `worlds/korvin-merrow/task-context-files/candidate-review/`.
...
- FI-T01 through FI-T07 are candidate review request-framing files.
...
- Task-Level Context File Architecture v1 is locked. FI-T01 through FI-T07 have been constructed as candidate request-framing files only. No FI-S files, supplementary files, prompts, goldens, grader guidance, AutoQC responses, DOCX artifacts, or submission materials have been created. P0/P1/P2 labels are tracker-provenance metadata only, not governing workflow architecture.
...
- Task-Level Context File Architecture status: COMPLETE.
- Task-Level Context File Construction status: CANDIDATE REVIEW.
- Candidate files: `worlds/korvin-merrow/task-context-files/candidate-review/`.
