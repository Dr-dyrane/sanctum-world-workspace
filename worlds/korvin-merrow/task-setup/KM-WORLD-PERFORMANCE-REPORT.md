...
| KM08 | 1l71a77d | Awaiting Final Human Review post PL (v7 photo pilot 062652b2, all-floor legitimate photo miss, FA/GA and three PLs complete per Alexander) | Fred M | — |
| KM09 | 0zko93d5 | Awaiting First Human Review (v2 clean HIM-summary pilot 8ca908b5, FA/GA drafted from Attempt 6 at 0.15) | Fred M | — |
| KM10 | ixr0ddb9 | Ready for Delivery (GA fix in after AO second review; mount-coherence and all-floor no-catcher caveats on record) | Fred M | — |

Board sync 2026-06-12 (PM): six tasks delivered and accepted (KM01 through KM06); KM07 and KM10 are Ready for Delivery, KM08 awaits final human review post PL, and KM09 awaits first human review. KM07 v3 was ruled unfair on the built bytes after AO's second review; KM07 v4 true-placeholder job db57dc63 then produced a useful spread, Trajectory Quality pass on rescore, Taiga QA pass, Feedback AutoQC pass, FA/GA from Attempt 10, and three PLs. Alexander reported KM07 ready for delivery on 2026-06-12. KM08 was returned by AO on 6/11: v4.1 pre-wrote the scored gabapentin uptitration order under a finalize-only prompt, and AO described the attached draft as an admission-status determination, raising a stale-mount concern. v5 fixed the fairness issue but all-caught in job ecf22f03. v6 kept the true placeholder and external signout but all-caught in job 0a327b65. v7 added the off-text bedside photo and piloted in job 062652b2 at 15,15,30,20,20,20,15,30,30,20. Attempt 1 shows both agent and grader saw the PNG; the model safely declined gabapentin escalation but falsely documented no wound on a visible plantar lesion. FA/GA and three PLs are complete per Alexander, with local PL backups tracked in `task8/preference-labeling/`. KM09 v2 fixed AO's missing original coding document by mounting one external HIM preliminary inpatient coding summary, then piloted cleanly in job 8ca908b5 at 20,20,15,15,92,15,20,15,85,25. Attempt 6 is the FA/GA subject after ratifying A41.9 sepsis principal and the septicemia family; Attempts 5 and 9 are catchers, proving reachability. KM10 v2 job 138e90a2 exposed the calendar volume, with cdi_query_memo_05262026.docx under both /docs/filesystem and /docs/.apps_data/calendar, and is excluded. KM10 v3 job 62fc109e repeated the all-floor pattern after a balanced CDI query surface; bank path selected because the task is an external CDI query, not a planted-error draft. AO second review accepted the FA as okay but returned the GA because it selected Great while mostly advising the grader; the corrected GA now supports Great by assessing the grader's actual 0.15 against the model output and golden.
...
| KM09 | 8ca908b5 | 20, 20, 15, 15, 92, 15, 20, 15, 85, 25 (v2, clean HIM task-file mount) | 32.2% | 15 | 92 | 8 | 9 |
...
| Deepest floors (suite killers) | KM08 21.5 (all-floor), KM10 22.9 (all-floor), KM09 32.2 |
...
| KM09 | Att 6 / a7259530 from v2 | 0.15 | Ratified A41.9 sepsis as principal and assigned septicemia family | Correctly rejected severe sepsis, metabolic encephalopathy, acute-on-chronic HF, and organism coding |
...
| KM09 | >= 1 trajectory < 90 + genuine clinical failure | PASS | v2 job 8ca908b5 produced 8 sub-70 deep floors with a clean HIM-summary mount; 0.92 and 0.85 catchers prove reachability |
...
| KM08 | v7 Attempt 1 / 0.15 | submitted per Alexander | Grader appropriately floors the false no-wound reassurance despite safe gabapentin handling; minor presentation weakness only | FA/GA and three PLs complete; awaiting final review post PL |
| KM09 | 0.15 from v2 Attempt 6 | drafted | Grader correctly floors sepsis-principal ratification while crediting correct secondary-code restraint | Catch runs: 0.92 and 0.85 |
...
| KM09 | 2 (v1.1 hard but returned for missing original coding document; v2 added HIM preliminary worksheet and cleared pilot at 24.2 mean) | Forced coding inventory against severity anchoring, now with real addendum source file |
...
| KM09 v2 FA/GA entry from Attempt 6, then FA/GA AutoQC | Alexander | Pending platform entry - draft in task9/fa-ga/FA-GA-current.md |
| KM10 corrected GA entry from v3 Attempt 3, then FA/GA AutoQC if required | Alexander | Pending platform correction - FA okay per AO, GA fixed in task10/fa-ga/FA-GA-current.md |
