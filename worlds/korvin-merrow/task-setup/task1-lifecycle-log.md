...
- Task 1: FA/GA AutoQC submitted 1/14 justified -> Task 1 complete on writer side, now in reviewer hands (First Reviewer through FA/GA; Final Reviewer for Preference Labels later). No further writer action unless a reviewer sends back.
