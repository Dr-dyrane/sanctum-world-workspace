...
Status: KM02 v3 complete locally and on platform; in Abi review.
...
Do not run additional platform steps, QA, AutoQC responses, uploads, submissions, or RLS mutations without Alexander explicitly authorizing the exact step.
