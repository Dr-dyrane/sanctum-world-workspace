...
## 9. The golden-date miss (first human review, 6/7): verification has a scope
The golden carried 05/23/2026 (clean-pilot framing: summary done today, discharge tomorrow) into the escalation, whose in-world today is 05/24 (goes home today, sign-out today). The draft was built to the new framing; the golden was assumed good because it had already passed under the old one. Abi caught it. The class: a framing change silently invalidates the verification status of every artifact that survives it; verification is relative to a framing, not a property of the file. Same class as the template miss seen from the other side (new artifact without consulting the record vs old artifact without re-consulting the framing). Operative rule: DATE AUDIT in TASK-RUNBOOK section A + AGENTS.md guardrail 5 (FRAMING-CHANGE RE-AUDIT). Fix record: surgical 2-replacement edit, sha 2dd3e0adb903, source anchor synced, clean prompt moved to hold/.
