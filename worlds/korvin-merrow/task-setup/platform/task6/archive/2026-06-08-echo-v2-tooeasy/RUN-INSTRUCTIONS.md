...
KM02-KM04 propagation regime: deep and fair and bimodal expected, mean high-50s to high-60s. The one caveat carried from the KM05 echo discussion: EF is mildly checkable, so a strong HF-aware model may verify the absence and catch it. Read the pilot by whether the floors carry the fabricated echo / de-escalation forward; if it clusters too high, the axis is warmer than hoped and we re-center (different cold axis or sharpen the plant), per the KM05 discipline.
