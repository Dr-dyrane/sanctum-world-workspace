...
- grader-guidelines-task4-v2.txt   (names golden-KM04-v2.docx)
...
READ THE PILOT:
- By PROPAGATION RATE: how many of the 10 carry the iron-studies / closed-anemia claim into the filed plan, not by the headline mean.
- Expected (KM03 regime): real sub-70 tail, mean plausibly high-60s to mid-70s. Do NOT louden if it sits at 70 to 72 (prereg rule); that is the regime.
- If caught across the board (clusters >=85), do not louden and do not clone again: KM04 holds at the cleared gate and the deep slot moves to KM06 (omission + red-herring).
