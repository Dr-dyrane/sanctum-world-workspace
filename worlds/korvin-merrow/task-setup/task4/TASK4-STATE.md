...
Do not run additional KM04 uploads, AutoQC, agents, QA, Preference Labeling, PL AutoQC, final review, platform mutations, staged-file edits, DOCX rebuilds, locked-canon edits, or live-world edits without explicit Alexander authorization for that exact step. FA/GA has been entered on platform (Attempt 9 at 0.30). FA/GA AutoQC is running. Next eligible steps: clear FA/GA AutoQC, then three Preference Labels, then PL AutoQC, then final review (Sang). Do not proceed to PL or final review without Alexander authorization.
