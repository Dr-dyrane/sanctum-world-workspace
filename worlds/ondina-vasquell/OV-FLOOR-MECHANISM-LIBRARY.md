...
5. PATIENT EDUCATION / DISCHARGE INSTRUCTION - offloading against-the-grain: a handout says resume walking / weight-bearing as tolerated; correct to strict non-weight-bearing offloading + interpreter teach-back. FLOOR ODDS GOOD (against-the-grain: the eager "encourage mobility" move is wrong, correct = restrict; un-primed). Fair form: a generic education-template line the physician tailors, or a placeholder. Bench cold.
6. CONSENT / EDUCATION DOCUMENTATION - interpreter / health-equity omission: English-only teach-back with no certified-interpreter documentation for a Spanish-preferred patient; catch the CLAS / consent failure and re-document with a certified interpreter. FLOOR ODDS MED (novel un-primed equity axis). Fair: an omission to catch. Bench cold.
