...
## 6. PATH TO 8 (current)
================================================================
1. OV01 - cold knowledge (BANKED). 2. OV02 - off-text synthesis (FAIR FLOOR, in review). 3. OV04 - CPAP/OSA over-closure (bench FLOOR 3/3) -> BUILD full package + pilot. 4. second over-closure on another un-primed axis (bone-health/CKD-MBD or health-maintenance) -> bench then build. 5. OV06 - external pharmacy/SNF-orders handoff with planted unsafe moves (KM01) -> bench. 6-8. additional un-primed-axis over-closures and/or the mounted-instrument family; bench each. Over-closure on multiple un-primed axes is the highest-yield engine.
