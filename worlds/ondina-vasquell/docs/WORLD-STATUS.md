...
| OV05 | v3 re-pilot pending | Wound Care SOAP / Progress Note (new lane) | embedded-wrong commission: silver alginate order vs clean low-exudate bed (v2 Dakin's ceilinged) | v3 built, gates green | v2 ceilinged 0.72-0.92; v3 subtler, awaiting re-pilot |
...
| OV07 | rebuilt v2 | Claims Denial | embedded-wrong closure: home-health suitability screen vs documented skilled need (was off-text image) | v1 sent back (AI photo); v2 built, gates green | Rebuilt off the image; awaiting re-pilot |
