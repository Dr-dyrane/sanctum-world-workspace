...
- 2026-06-14 OV02 0.62 grading transcript read: CONFIRMED the 0.62 was docked solely for not saving a file to /tmp/outputs (content graded "~0.9+"), not a clinical miss. Cross-cutting finding: conversational-prompt vs save-to-/tmp/outputs harness mismatch injects file-output noise into every task (also nicked OV01's 0.40). Decision pending: re-center OV02 on a judgment trap vs set aside as medium + pursue OV07; address file-output noise suite-wide.
