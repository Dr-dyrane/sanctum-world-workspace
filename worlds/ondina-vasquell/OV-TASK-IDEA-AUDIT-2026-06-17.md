...
Deep audit of the Ondina Vasquell slate. Sources reconciled: WORKFLOW-MAP.md, OV-FLOOR-MECHANISM-LIBRARY.md, DO-NOT-REPEAT.md, OV-FRESH-TASK-IDEAS.md, reference/approved-workflows-and-guidance-2026-06-13.md, every results/ pilot log, and the platform task mounts. World is frozen; all candidates are task-layer only.
...
| OV09 | Post-Acute Care Coordination Documentation | embedded wrong (offloading/disposition settled falsely) | PILOT-READY, untested |
