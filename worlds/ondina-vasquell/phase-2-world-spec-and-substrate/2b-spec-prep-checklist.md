...
| A2 | Comorbidity expansion (Stacey send-back: approved expansion required) | Current count is 6 (T2DM-insulin, CKD 3b, PAD, neuropathy, HFpEF, limited mobility). Target KM-approved depth, roughly 10 to 12 interacting common conditions. Candidate adds for Alexander to select or replace: diabetic retinopathy, prior toe ulcer or partial amputation history, hypertension, dyslipidemia, obesity, OSA, anemia of CKD, osteoarthritis, mild cognitive or mood overlay consistent with the SDOH design | OPEN FOR ALEXANDER |
