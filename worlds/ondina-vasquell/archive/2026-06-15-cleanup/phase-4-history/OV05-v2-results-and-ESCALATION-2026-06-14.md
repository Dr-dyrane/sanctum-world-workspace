# OV05 v2 results + STRUCTURAL ESCALATION - 2026-06-14

Pilot job 0af5b823. Scores: 92, 95, 92, 96, 96, 95, 95, 95, 92, 95. Mean ~94, lowest 0.92. NO floor.
The cold fluoroquinolone trap did not fire: every run declined the FQ (not culture-directed, elderly-CKD cautions) and chose the culture-directed agent or a formulary exception. The best cold candidate in the suite ceilinged.

## Tally: 9 ceiling pilots, 1 bank
OV01 BANKED (cold enoxaparin). OV02 x5, OV07 x1, OV10 x2, OV05 x1 = all ceilinged.

## Root cause (structural, set at world-build) = DO-NOT-REPEAT #1
...
2. Request a world-freeze EXCEPTION to plant 1-2 cold substrates (like the enoxaparin) into specific world files, accepting the downstream re-run cost - the only way to add real floors.
3. Ship low-yield: submit OV01 (+ anything that legitimately banks under King P's one-failure rule) and accept fewer strong tasks.
Do NOT keep grinding warm tasks (OV03/04/08/09) - they will produce more 0.95s.
