...
- Lens 6 answer-giving scaffolding: PASS. The order set proposes the wrong actions; no provided file teaches "stop enoxaparin." Not inflated.
...
- grader chart access: PASS = chart-aware (chart-readable grading) for the synthesis task; expect/justify the Self-Contained Guidelines flag.
