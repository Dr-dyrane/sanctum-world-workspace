...
Date: 2026-06-14. This reconciles the locked v2 prereg (`tasks/task1/current/OV01-v2-pilot-preregistration.md`) against the clean-mount result. The locked prereg is not edited; this is the results record.
