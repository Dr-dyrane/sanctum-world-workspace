...
4. The catch is verifiable in A's trajectory: it reviews the CPAP compliance report and extracts 9 of 30 nights used before building the finding into the note. Do not downgrade A to a partial handling; it makes the golden's affirmative move.
