...
- Build/regen: build/build_ov08.py renders the existing worksheet (via build_task_files._to_world_spec(task_data.T6())) and the golden into tasks/task8/current/.
