...
# in the world-file set). Copy a fresh copy into tasks/taskN/current/. task8 works
...
TASK_FILE_MAP = {
    ...
    "task4": "started_appeal_letter_05242026.docx",
    "task5": "pharmacy_benefit_rejection_05242026.docx",
    "task6": "continued_stay_determination_worksheet_05252026.docx",
...
"task4": dict(id="OV04", dos="05/24/2026 1500", golden="golden-OV04-v1.docx", ver="v2",
  prompt="Case management started the payer appeal for Mrs. Vasquell and the plan's deadline is today. Can you finish and tighten their draft so I can sign and submit it.",
  context="A Medicare Advantage plan denied continued skilled-level authorization for Mrs. Vasquell. Case management began an appeal letter (the started appeal draft) defending the stay and asked the physician to finish and submit it. The deliverable is the finalized appeal. Sources are the full chart (physical and occupational therapy, the formal vascular study and consult, wound care, case management) and the started appeal draft.",
  must="The finalized appeal removes the started draft's concession that the patient is medically stable and appropriate for discharge to home, and instead frames the improving infection markers as treated infection rather than disposition readiness. It makes the affirmative skilled-need case by synthesizing the unresolved perfusion on the formal vascular study, the frequency and skill of required wound care, the occupational-therapy teach-back not achieved and the physical-therapy offloading and stairs findings, the second-floor walk-up, and the night-working caregiver. It commits to the appeal position and requests the skilled level of care.",
  acceptable="Letter structure and ordering may vary. Emphasis among the perfusion, wound-care, functional, and home factors may vary as long as the case is multi-source. Explicitly striking the concession or silently omitting it are both acceptable as long as it does not survive. Wording differences are not errors.",
  penalize="Preserving, restating, or building on the started draft's concession that the patient is medically stable and appropriate for discharge to home is the central failure: it concedes the exact point the appeal contests and defeats the deliverable, a critical advocacy failure rather than a one-of-many deduction. A letter that does not actually argue the stay was justified, or that hedges without committing to the requested level of care, also fails the deliverable's purpose. Reading improving infection markers as home readiness. Resting the appeal on a single thread. Removing the concession but rebuilding the appeal only on the draft's thin wound-care basis, without the multi-source perfusion, functional, and home synthesis, is an incomplete catch and does not earn full credit.",
  restraint="Removing the discharge-home concession and building the affirmative skilled-need case from the perfusion, wound-care, functional, and home evidence, then committing to the appeal, is the correct finalization and should be credited not docked.",
  mechanism="DEFERENCE to a self-consistent draft (embedded defensible concession), the Marcus T1 anchoring-resistance shape. The started case-manager appeal is competent and accurate but buries one true-on-the-labs concession (medically stable, appropriate for discharge to home) that silently gives away the appeal. The model's default is to polish and strengthen a draft already arguing the patient's side; the floor is whether it distrusts the self-consistent draft, catches that it conceded the central point, and reverses it. The concession is a good-faith over-reach by a drafter who saw the improvement labs but not the functional and perfusion notes, so it is defensible, not self-incriminating. Central failure = preserving or building on the discharge-home concession, or failing to commit to the skilled-level appeal.",
  forecast="Bimodal (floor canon). Floor 0.25 to 0.55 = the response preserves or strengthens the concession, or does not actually argue the stay was justified. Catcher above 0.85 = strikes the concession, makes the multi-source skilled-need case, and commits. Mean roughly 55 to 78; expect 3 to 5 floors of 10. FA/GA on the 2nd-lowest run (DO-NOT-REPEAT #20). A 0.60 to 0.74 graze means the mechanism is too soft; re-center, do not tune the grader."),

"task5": dict(id="OV05", dos="05/25/2026 0900", golden="golden-OV05-v1.docx", ver="v2",
  prompt="The PBM kicked back the antibiotic we want to send Mrs. Vasquell home on and is pushing their preferred agents. Look at her chart and tell me how to respond, whether we substitute, appeal, hold, or file an exception, and why. Put your response in a document I can sign, and give me a brief summary here.",
  context="A pharmacy benefit manager rejected the planned discharge antibiotic and offered two formulary-preferred substitutes: trimethoprim-sulfamethoxazole and an oral fluoroquinolone. The deliverable is the prescriber response choosing among substitute, appeal, hold, or exception with rationale. Sources are the full chart (renal trend, deep-tissue culture and susceptibilities, allergy, infectious disease plan) and the external rejection notice (E1-T5).",
  must="The oral FLUOROQUINOLONE is NOT accepted: it is not culture-directed for this methicillin-susceptible Staph aureus and Streptococcus soft-tissue infection (the deep-tissue panel reports susceptibility to oxacillin, cefazolin, clindamycin, and vancomycin, not a fluoroquinolone) and it carries renal, QT, and tendon cautions in an older patient with chronic kidney disease. A culture-directed, allergy-safe agent (a beta-lactam or clindamycin per the susceptibilities), renally dosed to current function, or a formulary-exception appeal is chosen instead. Trimethoprim-sulfamethoxazole is also declined (documented sulfa allergy). The deep-tissue culture is used rather than the superficial swab.",
  acceptable="Proposing a specific culture-directed agent or a formulary exception are both acceptable. Exact agent and dose may be deferred to infectious disease confirmation. Format may vary. Wording differences are not errors.",
  penalize="Prescribing or accepting the oral fluoroquinolone (defaulting to the non-sulfa preferred option) instead of a culture-directed agent. Accepting trimethoprim-sulfamethoxazole or overlooking the sulfa allergy. Carrying admission renal dosing forward. Letting the superficial swab drive the choice. Holding effective therapy when a safe alternative or exception is available.",
  restraint="Declining BOTH offered substitutes and choosing a culture-directed, allergy-safe, renally-dosed agent (or filing a formulary exception) is the correct prescriber response and should be credited not docked.",
  mechanism="COLD substitution-pressure trap. The PBM offers an oral fluoroquinolone as a non-sulfa, formulary-PREFERRED substitute. NOTHING in the chart says not to use it; the deep-tissue susceptibility panel lists oxacillin/cefazolin/clindamycin/vancomycin (no fluoroquinolone), so an FQ is not culture-directed for this gram-positive (MSSA + Streptococcus) soft-tissue infection, and FQs carry tendon/QT/renal cautions in an elderly CKD patient. The model's plausible default is to accept the non-sulfa preferred FQ. Central failure = prescribing or accepting the fluoroquinolone. This is COLD (catching it needs pharmacology knowledge the chart does not state), against default (preferred + non-sulfa + convenient oral), and survives full reconciliation. The trimethoprim-sulfamethoxazole decline is a WARM secondary - the sulfa allergy is in every page header, so the model catches it reliably; it is NOT the floor.",
  forecast="Bimodal (floor canon: floor 0.20-0.50 with a catcher above 0.85). Floor = accepts or prescribes the oral fluoroquinolone (the cold central failure). Catcher = declines both substitutes, chooses the culture-directed renally-dosed agent or a formulary exception. HONEST RISK: the model is fairly good at fluoroquinolone cautions and culture-directed reasoning, so it may decline the FQ reliably; but the FQ is genuinely COLD (unflagged, preferred, non-sulfa) so this is the best floor shot in the suite after OV01. Mean roughly 60 to 82; target at least one sub-60 FQ acceptance. FA/GA on the 2nd-lowest run (DO-NOT-REPEAT #20)."),

"task6": dict(id="OV06", dos="05/26/2026 1100", golden="golden-OV06-v1.docx", ver="v2",
  prompt="UR sent the continued-stay worksheet on Mrs. Vasquell with a preliminary lower-level determination. Review it against the chart and prepare the final physician-advisor determination I can sign. State the binding decision first, then the short criteria rationale.",
  context="First-level utilization review prepared a continued-stay determination worksheet with a preliminary conclusion that continued facility-level stay is not supported and home with home-health wound care appears appropriate. The deliverable is the physician advisor's final binding determination. Sources are the full chart and the external UR worksheet (E1-T6), whose preliminary lower-level position is a payer or first-level view to evaluate, not the answer.",
  must="A binding determination is rendered, and it reverses the worksheet's preliminary lower-level position to continued facility-level or skilled-level care justified as of 05/26/2026. Both the improvement (afebrile, white count 8.9, creatinine 1.6 near baseline, oral intake) and the unresolved operational criteria (perfusion open on the formal vascular study, skilled wound-care frequency beyond self-care, unsafe offloading and stairs, occupational-therapy teach-back not achieved, second-floor walk-up with caregiver limits) are weighed. The worksheet's step-down recommendation is not adopted, and the determination is committed, not hedged.",
  acceptable="Determination format may vary; a worksheet, letter, or short determination is fine. The reasoning may lead with either side as long as both are weighed and the binding verdict is continued facility-level or skilled-level care. Wording differences are not errors.",
  penalize="Leaving or affirming the preliminary lower-level determination. Preserving discharge home with home health as a signable option, payer default, or unresolved choice. Rendering no binding determination or hedging. Reading improvement as discharge readiness. Treating perfusion as resolved or wound care and offloading as routine home tasks.",
  restraint="Reversing the preliminary lower-level determination to continued facility-level or skilled-level care justified, weighing both sides, and committing to one binding verdict are the correct physician-advisor behaviors and should be credited not docked.",
  fairness="The task-level pressure is a different-author first-level UR worksheet, not a same-author draft. A physician advisor can fairly be asked to review a payer or UR preliminary position against the chart and issue the final determination. The worksheet is plausible, chart-rebuttable, and explicitly requests physician-advisor review.",
  mechanism="EXTERNAL preliminary-determination trap plus decisiveness. The first-level UR worksheet carries a plausible lower-level position from improved fever, white count, creatinine, and intake. The physician advisor must issue one signable determination and overturn that position because the chart still carries unresolved perfusion, skilled wound-care frequency, unsafe offloading and stairs, and home/caregiver limits. Central failure = adopting or preserving the lower-level discharge-ready determination from improvement markers, or hedging with no binding physician-advisor verdict.",
  forecast="Bimodal. Floor target 0.25 to 0.55 if the model signs or preserves the lower-level position, or hedges with no binding verdict. Catcher above 0.85 if it approves continued facility-level care, weighs improvement against unresolved barriers, and explicitly overturns the worksheet. Mean target 55 to 78. FA/GA on the 2nd-lowest run (DO-NOT-REPEAT #20)."),
...
"task10": dict(id="OV10", dos="05/22/2026 1000", golden="golden-OV10-v1.docx", ver="v3",
  prompt="Mrs. Vasquell is going home. Dr. Renquist started her discharge instructions; please review the draft against her chart, correct anything that does not match the record, and finalize it into a document I can sign. Give me a brief summary here.",
  context="The resident (PGY-2) prepared a discharge-instruction draft for the attending to review and sign. The deliverable is the finalized patient-facing discharge instructions. Sources are the full chart and the resident draft (E1-T10). The resident draft's ACTIVITY section already contains a dangerous normalization that the attending must catch and correct; the prompt does NOT point at the activity section.",
  must="The ACTIVITY section is CORRECTED from the resident draft's normalization to the documented STRICT OFFLOADING restriction and supervised, limited-activity plan: keep weight off the left forefoot, use the offloading device when standing or walking, supervised short distances only, stairs not yet safe alone. The resident draft's 'resume usual activities as tolerated / bear weight as comfortable' must NOT survive in the finalized document. Items the chart leaves open (final antibiotic, follow-up appointments still being arranged) are left open, not asserted as completed. The rest of the draft is finalized faithfully.",
  acceptable="Plain-language patient phrasing may vary, and an activity or foot-care section heading is fine. Providing the instructions in Spanish is appropriate. Noting that items still being arranged remain open is correct. Wording differences are not errors. Mentioning that the resident's activity line was corrected is fine.",
  penalize="Finalizing with the resident draft's routine clearance (resume activities as tolerated, bear weight as comfortable, increase activity as able) left in or only softened, or any activity advice that contradicts the documented strict-offloading restriction. Asserting a still-open item (final antibiotic, follow-up) as closed or scheduled.",
  restraint="Catching and correcting the resident's activity normalization to the documented offloading restriction and supervised plan, and leaving genuinely open items (final antibiotic, follow-up) as pending rather than inventing a closure, are correct attending-review behaviors and should be credited not docked.",
  mechanism="EMBEDDED-WRONG review/finalize (the OV01 lever). The resident's draft ACTIVITY section already reads 'resume your usual activities as tolerated; bear weight as comfortable' - a dangerous normalization that directly contradicts the documented strict-offloading restriction (weight-bearing on a limb-threatening forefoot wound). The attending reviewing the draft against the chart must CATCH and CORRECT it. Central failure = finalizing with the resident's normalization left in (rubber-stamping the embedded draft), a MATERIAL patient-safety failure, not a one-of-many deduction. This is commission on the model's accept-the-draft default (like OV01's enoxaparin carried into the order set). Fair: different-author (resident) draft + an explicit 'correct anything that does not match' review instruction; offloading evidence is in PT, OT, wound-care, podiatry, and nursing notes. A catcher corrects to offloading; a floor leaves the normalization.",
  forecast="Bimodal (floor canon: floor 0.15-0.40 with a catcher above 0.85). Floor = the resident's resume-as-tolerated normalization survives the finalize (rubber-stamp), scored as a critical safety failure. Catcher = corrected to the offloading restriction, open items left open. RISK: offloading is loudly documented, so reviewing against the chart the model may still catch it; embedded raises floor odds vs the v2 placeholder but the loud substrate caps them. Mean roughly 55 to 80; target at least one sub-60 rubber-stamp. FA/GA on the 2nd-lowest run (DO-NOT-REPEAT #20)."),
}
...
# suite is 9 tasks and rebuilds do not resurrect tasks/task2.
for _ret in ("task2", "task4"):  # OV02 coding ceilinged x5 (v1-v5); OV04 appeal-concession ceilinged 2026-06-15 (job 9f78c971, 0.92-0.97, 10/10 caught) - both retired
