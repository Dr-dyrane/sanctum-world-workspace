...
Golden, grader, started draft, mount, and workflow are UNCHANGED. Also set enable_anthropic_api=True on the task config (QA technical warning: the agentic grader needs API access at grading time).
