...
## Build / regen
- python3 worlds/ondina-vasquell/phase-3-build-task-artifacts/build/build_ov08.py renders the existing worksheet (via build_task_files._to_world_spec(task_data.T6())) and the golden into platform/task8/current/. No images.
