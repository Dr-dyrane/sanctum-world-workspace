...
"task2": dict(id="OV02", dos="05/22/2026 0900", golden="golden-OV02-v1.docx",
  ...
  must="The anemia is attested as anemia of chronic kidney disease only; acute blood loss anemia is NOT attested, because the hemoglobin is stable at 9.8 across the admission with no documented bleeding or transfusion. The diabetic foot ulcer with deep soft tissue infection or cellulitis family is selected as principal, supported by the ED, podiatry, and wound notes. Acute osteomyelitis is NOT attested as established or present on admission, because the imaging is equivocal, the debrided specimen contains no bone, and infectious disease did not sign it. The pressure-injury family is not coded. Documented diabetes, chronic kidney disease with acute kidney injury, and peripheral arterial disease are retained. Present-on-admission status is assigned per documented onset.",
  ...
  penalize="Attesting acute blood loss anemia for what the record shows is a stable chronic anemia of chronic kidney disease. Selecting the pressure-injury family for this neuropathic and ischemic diabetic foot ulcer. Attesting acute osteomyelitis as established or present on admission. Upcoding to an unsupported severity tier or DRG. Dropping documented supported comorbidities. Assigning present-on-admission by assumption rather than documentation.",
  ...
  forecast="Mean roughly 60 to 80, bimodal. Central failure = attesting acute blood loss anemia against the stable hemoglobin 9.8 (the cold upcode); secondary failures = a pressure-injury principal or osteomyelitis POA. Floors 0.30 to 0.55; expect at least one sub-70 if the cold anemia line propagates."),
