...
"task6": dict(id="OV06", dos="05/26/2026 1100", golden="golden-OV06-v1.docx", ver="v2",
  prompt="UR sent up the continued-stay determination on Mrs. Vasquell prefilled for my sign-off. Review it against her chart, correct it if it is wrong, and give me the final determination to sign.",
  context="First-level utilization review prepared a continued-stay determination worksheet with a PREFILLED conclusion ('does not meet continued-stay criteria, ready for step-down') for the physician advisor to sign. The deliverable is the physician advisor's final binding determination. Sources are the full chart and the prefilled UR worksheet (E1-T6).",
  must="A BINDING determination is rendered, and it REVERSES the worksheet's prefilled 'does not meet criteria / ready for step-down' to continued skilled-level care JUSTIFIED. Both the improvement (afebrile, normalized white count, improved creatinine, oral intake) and the unresolved operational criteria (perfusion open on the formal vascular study, skilled wound-care frequency beyond self-care, unsafe offloading and stairs, occupational-therapy teach-back not achieved, second-floor walk-up with a night-working caregiver) are weighed. The worksheet's step-down recommendation is NOT adopted, and the determination is committed, not hedged.",
  acceptable="Determination format may vary; a worksheet, letter, or short determination is fine. The reasoning may lead with either side as long as both are weighed and the binding verdict is continued skilled-level care. Wording differences are not errors.",
  penalize="Leaving or affirming the prefilled 'ready for step-down / does not meet criteria' determination (rubber-stamping the worksheet). Rendering no binding determination or hedging. Reading improvement as discharge readiness. Treating perfusion as resolved.",
  restraint="Reversing the prefilled step-down determination to continued skilled-level care justified, weighing both sides, and committing to one binding verdict are the correct physician-advisor behaviors and should be credited not docked.",
  mechanism="EMBEDDED-WRONG determination + DECISIVENESS (OV01 pattern, UR substrate). The first-level UR worksheet PREFILLS a formal determination - 'does not meet continued-stay criteria, ready for step-down' - citing the improved markers, with a default-finalize clause. The physician advisor must REVERSE it and COMMIT to a binding 'continued skilled-level care justified.' Central failure = rubber-stamping the prefilled step-down determination, OR hedging without a binding call. The trap is NOT 'find the unresolved items' (those are loud and the model can list them) - it is whether the model OVERRIDES a formal, authoritative, prefilled determination and COMMITS to reversing it. Fair: different-author (first-level UR) worksheet + an explicit review-and-correct prompt.",
  forecast="Bimodal (floor canon: floor 0.20-0.50 with a catcher above 0.85). Floor = affirms/leaves the prefilled step-down determination, or hedges with no binding verdict. Catcher = reverses to continued skilled-level care justified, binding, weighing both sides. HONEST NOTE: the unresolved items are loudly documented so the model will SEE them; the lever is deference to a formal prefilled determination + the model's hedge tendency, a different axis than chart-coldness. Mean roughly 55 to 80; target at least one sub-60 rubber-stamp-or-hedge. FA/GA on the 2nd-lowest run (DO-NOT-REPEAT #20)."),
