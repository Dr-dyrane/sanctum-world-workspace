...
"task2": dict(id="OV02", dos="05/22/2026 0900", golden="golden-OV02-v1.docx",
  prompt="This is the preliminary coding worksheet on Mrs. Vasquell before we finalize. Go through the chart and give me your attestation line by line, principal diagnosis, present on admission, and the code families you support. Put the final physician coding attestation in a saved document, then provide a brief confirmation in chat.",
