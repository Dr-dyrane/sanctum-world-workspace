...
platform/task10/current/. Frozen-world-safe: task-layer artifacts only; no world edits.
...
OUT = REPO / "worlds/ondina-vasquell/phase-3-build-task-artifacts/platform/task10/current"
