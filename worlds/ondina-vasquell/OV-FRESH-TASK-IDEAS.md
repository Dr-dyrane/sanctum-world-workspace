...
- CURRENT banked/active levers, the real "do not duplicate" list: for the live and authoritative list of built levers and their status, see OV-WORLD-STATUS.md. As of 2026-06-18: OV01 cold-knowledge enoxaparin, OV02 off-text line-infection synthesis, OV03 carry-forward sliding-scale insulin, OV04 off-text CPAP image, OV05 skilled-wound-care downgrade, OV06 vascular perfusion closure, OV07 off-text wound undermining, OV08 antibiotic-route, OV09 held-med resume, OV10 bone-health over-closure. The OV0X notes further down predate OV04 and are historical.
