...
1. Use `worlds/korvin-merrow/grader-guidance-architecture/locked/grader-guidance-architecture-v1.md`, `worlds/korvin-merrow/grader-guidance-architecture/ratifications/grader-guidance-architecture-ratification.md`, and candidate GG-KM01 through GG-KM06.
...
3. Verify the candidate guidance rewards strong physician reasoning rather than verbatim golden matching.
4. Do not lock grader guidance, create scoring rubrics, scoring thresholds, AutoQC responses, DOCX artifacts, or submission artifacts before explicit authorization.
...
- reopen locked expected outputs, revise locked goldens, lock grader guidance, create scoring rubrics, create scoring thresholds, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- write additional grader guidelines beyond GG-KM01 through GG-KM06 candidate drafts or lock/ratify grader guidance;
- do failure analysis;
...
- support Grader Guidance Construction Review only if Alexander authorizes that phase.
