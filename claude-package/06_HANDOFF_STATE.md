...
If asked to help now, Claude should support Task 1 reviewer-hands monitoring and Tasks 2-6 setup preparation:
...
- support the current Task 1 sequence: monitor reviewer handoff and do not mutate platform state without explicit authorization;
