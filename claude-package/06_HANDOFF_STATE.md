...
Next eligible phase is Golden Construction.

For the next preparation step:

1. Review `worlds/korvin-merrow/expected-outputs/locked/EO-KM01.md` through `EO-KM06.md`, `worlds/korvin-merrow/expected-outputs/locked/expected-output-construction-validation-review.md`, and `worlds/korvin-merrow/expected-outputs/ratifications/expected-output-construction-ratification.md`.
2. Cross-check against locked Expected Output Architecture, Task Prompts, Governance Package, File Inventory, Task Architecture Package, Task-Level Context File Architecture, Supplementary File Architecture, ratifications, and reconciliation records.
3. Do not proceed into Golden Construction, create goldens, create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, or create submission artifacts before explicit authorization.
...
- reopen locked expected outputs, proceed into Golden Construction, create goldens, create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- prepare for Golden Construction only if Alexander authorizes that phase.
