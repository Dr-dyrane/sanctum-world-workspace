...
Project Sanctum onboarding is in Phase 1 World Building. Alexander has explicitly authorized local construction beyond the earlier steps through Batch 2 synthetic world-level file construction. Batch 1 is locked; Batch 2 is constructed for candidate review and is not locked.
...
Wait for Batch 2 candidate review and ratification direction before moving or locking the Batch 2 files.
...
4. Do not create FI-W14 or later, or downstream file/task outputs.
...
- create FI-W14 or later before explicit authorization;
