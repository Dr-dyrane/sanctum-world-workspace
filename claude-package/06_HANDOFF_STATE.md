...
If asked to help now, Claude should support Task 1 FA/GA AutoQC gate and Tasks 2-6 setup preparation:
...
- support the current Task 1 sequence: run Failure Analysis & Grader Analysis AutoQC, then move Task 1 to reviewer hands if clean;
