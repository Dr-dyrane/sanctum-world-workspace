...
For the next construction step:

1. Use `worlds/korvin-merrow/grader-guidance-architecture/locked/grader-guidance-architecture-v1.md` and `worlds/korvin-merrow/grader-guidance-architecture/ratifications/grader-guidance-architecture-ratification.md`.
...
3. Preserve the rule that grader guidance rewards strong physician reasoning rather than verbatim golden matching.
4. Do not create scoring rubrics, scoring thresholds, AutoQC responses, DOCX artifacts, or submission artifacts before explicit authorization.
...
- reopen locked expected outputs, revise locked goldens, create scoring rubrics, create scoring thresholds, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- support Grader Guidance Construction only if Alexander authorizes that phase.
