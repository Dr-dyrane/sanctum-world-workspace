...
4. Do not create FI-S01 through FI-S04, supplementary files, or downstream file/task outputs without explicit authorization.
...
- create FI-S01 through FI-S04, supplementary files, task prompts, expected outputs, goldens, grader guidance, AutoQC responses, DOCX artifacts, RL Studio submission artifacts, or final task outputs before explicit authorization;
...
- prepare for Supplementary File Architecture / Construction only if Alexander authorizes that phase.
