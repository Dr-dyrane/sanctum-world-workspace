...
1. Use `worlds/korvin-merrow/grader-guidance-architecture/locked/grader-guidance-architecture-v1.md`, `worlds/korvin-merrow/grader-guidance-architecture/ratifications/grader-guidance-architecture-ratification.md`, locked GG-KM01 through GG-KM06, and `worlds/korvin-merrow/grader-guidance/ratifications/grader-guidance-construction-ratification.md`.
2. Cross-check against locked Golden Architecture, Expected Output Architecture, expected outputs, task prompts, Governance Package, File Inventory, FI-W/FI-T/FI-S sources, ratifications, and reconciliation records.
3. Preserve the locked guidance principle that grading rewards strong physician reasoning rather than verbatim golden matching.
4. Do not create scoring rubrics, scoring thresholds, pass/fail bands, point allocations, AutoQC responses, DOCX artifacts, or submission artifacts before explicit authorization.
...
- reopen locked expected outputs, revise locked goldens, create scoring rubrics, create scoring thresholds, create pass/fail bands, create point allocations, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- support AutoQC / Packaging Preparation only if Alexander authorizes that phase.
