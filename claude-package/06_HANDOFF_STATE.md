...
1. Review `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-v1.md` and `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-validation-review.md`.
...
3. Confirm the architecture rewards strong physician reasoning rather than verbatim golden matching.
4. Do not create actual grader guidance, scoring rubrics, scoring thresholds, AutoQC responses, DOCX artifacts, or submission artifacts before explicit authorization.
...
- reopen locked expected outputs, revise locked goldens, create actual grader guidance, create scoring rubrics, create scoring thresholds, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- review Grader Guidance Architecture v1 candidate artifacts only if Alexander authorizes that review.
