...
4. Do not lock Supplementary File Architecture v1, create FI-S01 through FI-S04, create supplementary files, or create downstream file/task outputs without explicit authorization.
...
- lock Supplementary File Architecture v1, create FI-S01 through FI-S04, create supplementary files, task prompts, expected outputs, goldens, grader guidance, AutoQC responses, DOCX artifacts, RL Studio submission artifacts, or final task outputs before explicit authorization;
...
- prepare for Supplementary File Architecture Ratification and Lock only if Alexander authorizes that phase.
