...
4. Do not lock FI-S01 through FI-S04 or create downstream file/task outputs without explicit authorization.
...
- lock FI-S01 through FI-S04, create task prompts, expected outputs, goldens, grader guidance, AutoQC responses, DOCX artifacts, RL Studio submission artifacts, or final task outputs before explicit authorization;
...
- prepare for Supplementary File Construction Review only if Alexander authorizes that phase.
