...
Next eligible phase is AutoQC Construction.

For the next preparation step:

1. Use `worlds/korvin-merrow/autoqc-architecture/locked/autoqc-architecture-v1.md`, `worlds/korvin-merrow/autoqc-architecture/locked/autoqc-architecture-validation-review.md`, and `worlds/korvin-merrow/autoqc-architecture/ratifications/autoqc-architecture-ratification.md`.
...
- support AutoQC Construction only if Alexander authorizes that phase.
