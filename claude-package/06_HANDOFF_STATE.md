...
If asked to help now, Claude should support Task 1 Taiga QA feedback / pre-FA-GA and Tasks 2-6 setup preparation:
...
- support the current Task 1 sequence: DQ `tech issue` response, 5.1 Taiga QA Feedback AutoQC, 5.2 clearance, then FA/GA;
- use `worlds/korvin-merrow/task-setup/task1/FA-GA-independent-review-brief.md`, grading transcript findings, and the v1/v2 trajectory exports when Alexander opens the FA/GA gate;
