...
- preserve the post-Abi rework direction: both Task 1 task files are deleted, mechanism-agnostic v5 grader guidance is live, Task AutoQC is 2/68 justified, batch v3 rerun is complete, round-2 FA/GA is submitted, and the next action is Task 1 hardening/redesign because Abi found all v3 trajectories too high;
