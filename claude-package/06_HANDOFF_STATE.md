...
1. Review `worlds/korvin-merrow/goldens/candidate-review/Golden-KM01.md` through `Golden-KM06.md` and `worlds/korvin-merrow/goldens/candidate-review/golden-construction-validation-review.md`.
...
3. Do not ratify or lock goldens, create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, or create submission artifacts before explicit authorization.
...
- reopen locked expected outputs, ratify or lock goldens, create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- prepare for Golden Construction Review only if Alexander authorizes that phase.
