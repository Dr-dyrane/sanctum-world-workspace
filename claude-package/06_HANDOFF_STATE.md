...
1. Use `worlds/korvin-merrow/autoqc/locked/autoqc-construction-v1.md`, `worlds/korvin-merrow/autoqc/locked/autoqc-construction-validation-review.md`, `worlds/korvin-merrow/autoqc/ratifications/autoqc-construction-ratification.md`, `worlds/korvin-merrow/autoqc-architecture/locked/autoqc-architecture-v1.md`, and `worlds/korvin-merrow/autoqc-architecture/ratifications/autoqc-architecture-ratification.md`.
...
- support Packaging Architecture only if Alexander authorizes that phase.
