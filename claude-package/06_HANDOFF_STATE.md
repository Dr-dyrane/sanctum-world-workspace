...
Wait for Alexander to explicitly authorize Batch 1 Synthetic World-Level File Construction before creating any synthetic world-level file contents.
...
4. Do not create synthetic file contents, chart notes, or downstream file/task outputs.
