...
4. Do not lock Batch 4, create FI-W22, or create downstream file/task outputs without explicit authorization.
...
- lock Batch 4 or create FI-W22 before explicit authorization;
...
- review Batch 4 candidate files and carry-forward watch items;
- critique proposed Batch 4 ratification decision if Alexander requests review support.
