...
1. Use `worlds/korvin-merrow/autoqc-architecture/candidate-review/autoqc-architecture-v1.md` and `worlds/korvin-merrow/autoqc-architecture/candidate-review/autoqc-architecture-validation-review.md`.
...
- support AutoQC Architecture Review only if Alexander authorizes that phase.
