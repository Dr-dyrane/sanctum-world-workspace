...
Project Sanctum onboarding is in Phase 1 World Building. Alexander has explicitly authorized local construction beyond the earlier steps through Batch 5 synthetic world-level file candidate construction. Batch 1, Batch 2, Batch 3, and Batch 4 are locked. Batch 5 FI-W22 is in candidate review. FI-W20 inventory row reconciliation is recorded at `worlds/korvin-merrow/file-inventory/reviews/fi-w20-inventory-row-reconciliation.md` and preserves source-of-truth hierarchy and prednisone hierarchy.
...
4. Do not lock Batch 5 or create downstream file/task outputs without explicit authorization.
...
- lock Batch 5 before explicit authorization;
...
- review Batch 5 FI-W22 candidate content and carry-forward watch items if Alexander authorizes candidate review.
