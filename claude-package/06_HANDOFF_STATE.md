...
1. Use `worlds/korvin-merrow/autoqc/candidate-review/autoqc-construction-v1.md`, `worlds/korvin-merrow/autoqc/candidate-review/autoqc-construction-validation-review.md`, `worlds/korvin-merrow/autoqc-architecture/locked/autoqc-architecture-v1.md`, and `worlds/korvin-merrow/autoqc-architecture/ratifications/autoqc-architecture-ratification.md`.
...
- support AutoQC Construction Review only if Alexander authorizes that phase.
