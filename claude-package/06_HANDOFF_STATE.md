...
For the next architecture step:

1. Review `worlds/korvin-merrow/goldens/locked/Golden-KM01.md` through `Golden-KM06.md`, `worlds/korvin-merrow/goldens/locked/golden-construction-validation-review.md`, and `worlds/korvin-merrow/goldens/ratifications/golden-construction-ratification.md`.
...
3. Do not create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, or create submission artifacts before explicit authorization.
...
- reopen locked expected outputs, revise locked goldens, create grader guidance, create rubrics, create AutoQC responses, create DOCX artifacts, create RL Studio submission artifacts, or create final task outputs before explicit authorization;
...
- prepare for Grader Guidance Architecture only if Alexander authorizes that phase.
