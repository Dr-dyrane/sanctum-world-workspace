...
- For Task 2, start with `worlds/korvin-merrow/task-setup/task2/FA-GA-current.md`, `worlds/korvin-merrow/task-setup/task2/KM02-taiga-qa-log.md`, and `worlds/korvin-merrow/task-setup/task2/escalation-run-v3/`; use `worlds/korvin-merrow/task-setup/task2/KM02-pilot-failure-analysis.md`, `worlds/korvin-merrow/task-setup/task2/pilot-run-clean/`, and `worlds/korvin-merrow/task-setup/task2/escalation-run/` as historical baselines only.
- For Task 3 inheritance, start with `worlds/korvin-merrow/task-setup/task3/KM03-design-plan-for-review.md` and `worlds/korvin-merrow/task-setup/KM-RETROSPECTIVE-tasks1-2.md`.
