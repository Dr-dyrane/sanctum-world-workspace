...
KM04 update 6/8: v1 failed the difficulty gate after job `55ee209f` (10 runs 0.87-0.95, mean 0.912, zero sub-70). V2 exists only as local planning/review: `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-plan.md` and `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`. Do not build, stage, upload, run AutoQC/Taiga, write FA/GA/PL, or mutate platform state from v2 without exact Alexander authorization.
...
- For Task 4, do not start from memory. First read `project/WORKSPACE_FILE_MAP.md` Navigation Rule, `worlds/korvin-merrow/task-setup/task4/TASK4-STATE.md`, `worlds/korvin-merrow/task-setup/task4/runs/KM04-taiga-results-55ee209f.md`, `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-plan.md`, and `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`. KM04 v1 has completed trajectory evidence and failed the difficulty gate; v2 is review-only planning; treat `platform/task4/current/`, `platform/task4/current/RUN-INSTRUCTIONS.md`, and prior black-team review files as v1 evidence only. Do not write FA/GA, Preference Labels, final review material, upload changes, rerun, build/stage v2, or redesign further without exact Alexander authorization.
