...
- Do not revise the locked Clinical Story Skeleton or locked Identity Package, draft new World Spec content, create milestones, revise locked file inventory, or lock Batch 5 until Alexander explicitly starts/authorizes the relevant phase.
...
- Batch 5 synthetic world-level file FI-W22 constructed as a candidate at `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/FI-W22_discharge-facing-plan-snapshot-before-world-close.md`.
- Batch 5 validation review recorded at `worlds/korvin-merrow/synthetic-files/candidate-review/batch-5/batch-5-validation-review.md`.
...
- Batch 5 Candidate Review and ratification-decision support when explicitly authorized.
...
- Locking Batch 5 before explicit Alexander authorization.
- Creating later synthetic file contents, chart notes, or downstream file/task outputs before explicit authorization.
