...
- For Task 2, start with `worlds/korvin-merrow/task-setup/task2/TASK2-STATE.md`, `worlds/korvin-merrow/task-setup/task2/fa-ga/FA-GA-current.md`, `worlds/korvin-merrow/task-setup/task2/qa/KM02-taiga-qa-log.md`, and `worlds/korvin-merrow/task-setup/task2/runs/escalation-v3/`; use `worlds/korvin-merrow/task-setup/task2/runs/clean-pilot/` and `worlds/korvin-merrow/task-setup/task2/runs/escalation-v2/` as historical baselines only. For Task 3, start with `worlds/korvin-merrow/task-setup/task3/TASK3-STATE.md`.
