...
1. Supplementary File Architecture Review, pending explicit authorization.
2. Supplementary File Architecture ratification and lock, only if review authorizes it.
3. FI-S construction, only after architecture lock and explicit authorization.
