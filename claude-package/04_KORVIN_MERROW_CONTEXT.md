...
1. Supplementary File Architecture ratification and lock, pending explicit authorization.
2. FI-S construction, only after architecture lock and explicit authorization.
