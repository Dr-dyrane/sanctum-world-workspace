...
Date: 2026-06-04, extended 2026-06-18 (Ondina spec-review, pod-guidance, task-mount lessons, clinical-date ceiling, and Vagus technical-routing/FA-PL updates, guardrails 14-19). Standing guardrails distilled from real failures during World Spec / artifact generation. Every rule here was paid for. Collaborators (Claude, Codex, writers) must follow these. AGENTS.md should reference this file.
