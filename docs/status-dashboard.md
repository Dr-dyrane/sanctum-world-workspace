...
- Grader Guidance Construction: candidate review
- Grader Guidance candidate artifacts: `worlds/korvin-merrow/grader-guidance/candidate-review/`
...
- Next eligible phase: Grader Guidance Construction Review. Do not lock grader guidance, create rubrics, scoring thresholds, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not proceed beyond Grader Guidance Construction candidate review into lock/ratification, rubrics, scoring thresholds, AutoQC, DOCX packaging, submission artifacts, or failure analysis without explicit authorization.
