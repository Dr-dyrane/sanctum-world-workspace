...
- Task 5 local review packet: `worlds/korvin-merrow/task-setup/task5/TASK5-STATE.md`, `task5/design/KM05-design-plan-for-review.md`, `task5/KM05-prebuild-review-and-build-gates.md`, and `task5/build-phase-drafts/`. Review-only, not a build or platform set.
...
- Task 1 final human review is complete. Task 2 / KM02 is complete through writer workflow and Awaiting Final Review after passing qcaud_5e, qcaud_4a, qcaud_ef, and Preference Labeling with verdict B / B++. KM03 v2.1 Task AutoQC passed and Taiga is held. KM04 is locally staged but not uploaded, AutoQC-run, or agent-run. KM05 is review-only and not build-ready. Do not run additional task uploads, agent runs, QA runs, platform responses, AutoQC responses, preference-label resubmission, KM05 build/platform staging, scoring rubrics, scoring thresholds, pass/fail bands, point allocations, manifest creation, final submission packaging, additional uploads, or additional submission actions without explicit Alexander authorization for the exact step.
...
6/7 late: KM05 PREBUILD REVIEW PACKET STAGED ONLY. Start at `worlds/korvin-merrow/task-setup/task5/TASK5-STATE.md`, `task5/design/KM05-design-plan-for-review.md`, `task5/KM05-prebuild-review-and-build-gates.md`, and `task5/build-phase-drafts/KM05-review-request-for-claude-ai.md`. No DOCX build, platform-current staging, RL Studio upload, Task AutoQC, Taiga trajectories, QA, or platform mutation.
