...
- Grader Guidance Architecture candidate artifacts: `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-v1.md`; `worlds/korvin-merrow/grader-guidance-architecture/candidate-review/grader-guidance-architecture-validation-review.md`
...
- Next eligible phase: Grader Guidance Architecture Review. Do not create grader guidance, rubrics, scoring thresholds, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not proceed beyond Grader Guidance Architecture candidate review into grader guidance construction, grader guidelines, rubrics, scoring thresholds, AutoQC, DOCX packaging, submission artifacts, or failure analysis without explicit authorization.
