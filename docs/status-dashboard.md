...
- Next eligible phase: Expected Output Construction Review. Do not create golden responses, grader guidance, rubrics, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not lock expected outputs or start golden responses, grader guidelines, rubrics, AutoQC, DOCX packaging, submission artifacts, or failure analysis without explicit authorization.
