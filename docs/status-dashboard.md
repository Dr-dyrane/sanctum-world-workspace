...
- Next eligible phase: Golden Construction. Do not create golden responses, grader guidance, rubrics, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not proceed beyond Golden Architecture completion into Golden Construction, golden responses, grader guidelines, rubrics, AutoQC, DOCX packaging, submission artifacts, or failure analysis without explicit authorization.
