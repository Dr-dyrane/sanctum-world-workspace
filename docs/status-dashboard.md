...
- Next eligible phase: Batch 4 Synthetic World-Level File Construction. Do not create FI-W17 through FI-W22, task specifications, task prompts, expected outputs, goldens, grader guidance, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not create Batch 4 synthetic files or create downstream task/file contents before Alexander authorizes that step.
