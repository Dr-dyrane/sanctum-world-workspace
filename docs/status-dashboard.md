...
- Next eligible phase: Golden Construction Review. Do not ratify or lock goldens, create grader guidance, rubrics, AutoQC responses, DOCX submission artifacts, or RL Studio uploads until explicitly authorized.
...
- Do not proceed beyond Golden Construction candidate review into ratification, lock, grader guidelines, rubrics, AutoQC, DOCX packaging, submission artifacts, or failure analysis without explicit authorization.
