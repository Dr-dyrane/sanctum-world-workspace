...
6. META. Rules written right after an error come out instance-shaped; write each rule at the CLASS it belongs to. Full detail and index: docs/reasoning-discipline.md (THE LAW + build gate), task-setup/TASK-RUNBOOK.md, task-setup/task2/learnings/KM02-learnings.md, docs/workspace-guardrails-lessons.md.
