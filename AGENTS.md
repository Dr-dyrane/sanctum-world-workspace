...
Active Task 1 lifecycle log: `worlds/korvin-merrow/task-setup/task1-lifecycle-log.md`. It wins over scattered summaries for Task 1 build/run status. Task 1 review records live at `worlds/korvin-merrow/task-setup/reviews/`: Abi first review, Abi round-2 review, and Abi final review are tracked. Task 1 platform provenance lives under `worlds/korvin-merrow/task-setup/platform/task1/`; the active/live platform artifact folder now contains only `prompt-task1-v5.txt`, `golden-response-task1-v6.docx`, `grader-guidelines-task1-v10.txt`, `medication_safety_handoff_pharmacy_05232026.docx`, and a local README. Superseded Task 1 prompts, goldens, grader guidelines, deleted round-1 task files, the handoff render PDF, and scratch/proof byproducts live under `worlds/korvin-merrow/task-setup/platform/task1/archive/` as historical evidence only. FA/GA and PL backups live at `worlds/korvin-merrow/task-setup/task1/FA-GA-final.md`, `worlds/korvin-merrow/task-setup/task1/FA-GA-current.md`, and `worlds/korvin-merrow/task-setup/task1/preference-label-task1-A-vs-B.md`. Task 2 pre-build/red-team material exists at `worlds/korvin-merrow/task-setup/task2/`: `KM02-design-plan-for-review.md`, `RED-TEAM-BRIEF-KM02.md`, `prompt-task2-v1-DRAFT.txt`, `Golden-KM02-v2-DRAFT.md`, `golden-KM02-source.md`, `golden-KM02-v4.docx`, and `KM02-redteam-bundle.zip`. These remain bounded review artifacts only; they do not authorize platform upload, agent runs, QA, AutoQC responses, or RL Studio mutation. A local Task 2 seed folder also exists at `worlds/korvin-merrow/task-setup/platform/task2/`, but both locations remain bounded prep only until Alexander authorizes further task setup or platform work.
