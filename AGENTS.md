...
KM04 v2 planning update: KM04 v1 failed the difficulty gate after job `55ee209f` (10 runs 0.87-0.95, mean 0.912, zero sub-70). Current v2 material is at `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-plan.md`, `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-review-request-for-claude-ai.md`, `worlds/korvin-merrow/task-setup/task4/build-phase-drafts/KM04-v2-build-proposal.md`, `worlds/korvin-merrow/task-setup/task4/build-v2/`, and `worlds/korvin-merrow/task-setup/platform/task4/current/`; v1 evidence is archived at `worlds/korvin-merrow/task-setup/platform/task4/archive/2026-06-08-pre-clean/`. The lead axis is anemia-of-CKD / absent iron-workup propagation; nutrition/oral-intake is backup / not recommended. Platform-current golden v2 has no bracketed placeholder and no DOCX core-metadata leak on read-only check, but still needs Alexander physician review/sign-off. No KM04 v2 upload, AutoQC, Taiga run, FA/GA, PL, final review, locked-canon edit, or live-world edit exists.
